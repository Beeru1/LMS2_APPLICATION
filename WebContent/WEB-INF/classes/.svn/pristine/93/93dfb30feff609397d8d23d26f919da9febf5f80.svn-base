...
public class NoneditablefieldsDTO {

	private String simno;
	
	private String customer_Segment;
	private String FamilymemberName;			//Fathers/Mothers/Husbands Name edit
	...
	private String previousoperatorname;//edit
	private String previouscircle;//edit
	private String existingpart;
	private String mnpstatus;
	private String documentCollectedFlag;//edit
