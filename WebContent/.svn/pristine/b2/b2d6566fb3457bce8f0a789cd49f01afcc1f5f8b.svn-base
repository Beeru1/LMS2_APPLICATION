...
<script language="javascript"> 
  ...
  //var redirectUrl='//easyaccess.airtelworld.in';
  var redirectUrl='//easyaccess.airtelworld.in/rbm/airtel';
function Redirect()
{
...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" style="background-image:url(./images/bg_1.jpg); background-repeat:repeat-y; background-position:center top;">
  ...
  <tr>
    <td colspan="3" align="center"><img src="./images/wrong.jpg" alt="" width="770" height="300" /></td>
  </tr>
  <tr>
...
<!--   <tr>
  ...
  <tr>
    <td height="265" colspan="3" align="center"><table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="#D9EEF6">
      <h3><strong><center><font color="red" size='5'>U might have taken wrong way</font></center> </strong></h3><br>
