...
function importExcelFwd(){
document.LeadForm.methodName.value= "excelImportFwd";
document.LeadForm.submit();
...
function searchLeadId()
{
	 var leadID= document.LeadForm.Lead.value;
 	...
 	if(leadID.length <14 || !isNumeric(leadID))
			{
			  alert("Please enter 14 digit numeric Lead Id.");
			return false;
			}
 	document.LeadForm.leadID.value=leadID;
 	document.LeadForm.methodName.value= "viewLeadDetail";
 	document.LeadForm.submit();
 	return true;
	...
	<div class="box2">               
        ...
        <logic:equal name="LeadForm" property="isError" value="true">
         ...
         <div class="content-upload">
          ...
          <li class="clearfix alt"> 
          	<span class="text2 fll width160 rightAlign"><strong>Lead ID &nbsp;&nbsp;&nbsp;<font color=red></font> </strong> </span>
     
          	<input type="text" name="Lead" id="Lead" maxlength="14" class ="text2 fll" style="background:white;height:24px"  border=""/>	
          <div class="button"><input type="submit" class="red-btn"  value="Search" onclick="return searchLeadId()"/></div>	
          		<STRONG><font color="red" size="4">&nbsp;&nbsp;&nbsp;<html:errors/></font></STRONG>
          </li>
		 <li class="clearfix alt">
	 ...
	 <div class="box2" >               
        ...
        <input type="checkbox" name="selectAll" onclick="selectAllCheckbox()"/>
			...
			<logic:iterate name="LeadForm" id="report" indexId="i" property="assignedLeads">
				...
				<logic:equal value="N" name="LeadForm" property="view">
					...
					<TD class="txt" align="left" width="15%"><A
						href="qualifiedLeads.do?methodName=viewLeadDetail&leadID=<bean:write name="report" property="leadID"/>" ><FONT color="red"><bean:write name="report"
			...
			<img  src="images/excel.gif" width="29px" height="25px" border="0" onclick="importExcelFwd();" /> 
		</logic:equal>
		</logic:notEmpty>
