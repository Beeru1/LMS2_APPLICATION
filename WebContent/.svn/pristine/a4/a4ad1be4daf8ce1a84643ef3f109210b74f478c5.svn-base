 ...
 <!--   <tr>
  ...
  <tr>
    <td height="265" colspan="3" align="center"><table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="#D9EEF6">
      <h3><strong><center><font color="red" size='5'>User logged out,please visit Easy Access page for Login in ILMS</font></center> </strong></h3><br>
      
      <h5><center><font color="blue" size='3'>Window will be closed within 5 seconds...........</font></center></h5>
    </table></td>
  </tr>
  <tr>
