...
public class LeadData_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public LeadData_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        LeadData bean = (LeadData) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_0_0;
          {
            propValue = bean.getCallDispositionList();
            if (propValue != null) {
