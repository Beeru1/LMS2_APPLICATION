package com.ibm.lms.wf.dto;


public class BulkMatrixDownloadDTO {
	...
	public String getLevel1CC() {
		return level1CC;
	}
	public void setLevel1CC(String level1CC) {
		this.level1CC = level1CC;
	}
