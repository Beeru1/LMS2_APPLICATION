		...
		try {
			...
			String RESTURL = ServerPropertyReader.getString("RESTFULLURL.APPONMENT");
				...
				try{
					...
					logger.info(RESTURL+"?lob=4G&tasktype=4G ODC Installation&"+"pin="+pin+"&startTime="+appointmentstart+"T"+appointmentst2+":00&endTime="+appointmentEnds+"T"+appointmented2+":05");
			 	...
			 	if (HttpResult == HttpURLConnection.HTTP_OK) {
			 		...
			 		logger.info(GetAppointmentsResponse.getString("Message")+"**********mess*******");
			 		...
			 		for(int i=0; i<arr.length(); i++){   
			 			  ...
			 			  logger.info("TimePeriod=============startTime=="+o.getString("startDateTime")+"*************end Time***********"+o.getString("startDateTime"));  
			 			}
