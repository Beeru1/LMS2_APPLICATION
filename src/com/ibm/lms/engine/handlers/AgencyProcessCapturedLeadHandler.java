...
public class AgencyProcessCapturedLeadHandler extends LMSHandler {
	
	private AgencyCaptureLeadDO captureLeadDO[];
	private static Logger lmsLogger=Logger.getLogger(AgencyProcessCapturedLeadHandler.class);

	public AgencyProcessCapturedLeadHandler(AgencyCaptureLeadDO[] captureLeadDO)
	{
