...
import com.ibm.appsecure.temp.UserDTO;
...
public class UserMstrDaoImpl implements UserMstrDao {
	...
	public static final String SQL_DELETE_USER ="UPDATE USER_MSTR SET STATUS = 'D',UPDATED_DT=current timestamp " +
	"WHERE UPPER(USER_LOGIN_ID) = ? AND STATUS = 'A' ";

	public static final String SQL_GET_CIRCLE_USERS ="select USER_ID from USER_MSTR where element_id= ? and KM_ACTOR_ID = 3 ";


	protected static final String SQL_INSERT_WITH_ID ="INSERT INTO USER_MSTR (USER_ID, USER_LOGIN_ID, USER_FNAME, USER_MNAME, USER_LNAME, USER_MOBILE_NUMBER, USER_EMAILID, USER_PASSWORD, USER_PSSWRD_EXPRY_DT, CREATED_DT, CREATED_BY,  STATUS, CIRCLE_ID, GROUP_ID, KM_ACTOR_ID, KM_OWNER_ID, LOGIN_ATTEMPTED, USER_LOGIN_STATUS, ELEMENT_ID, FAV_CATEGORY_ID,OLM_ID,PARTNER,PBX_ID,BUSINESS_SEGEMENT,ACTIVITY,ROLE) VALUES (NEXTVAL FOR KM_USER_ID_SEQ, ?, ?, ?, ?, ?, ?, ?, current timestamp + 45 DAYS, current timestamp , ?, ?, ?, ?, ?, ?, 0, 'N',?,?,?,?,?,?,?,?)";
	protected static final String SQL_SELECT ="SELECT USER_MSTR.USER_ID, USER_MSTR.USER_LOGIN_ID, USER_MSTR.USER_FNAME, USER_MSTR.USER_MNAME, USER_MSTR.USER_LNAME,USER_MSTR.USER_MOBILE_NUMBER, USER_MSTR.USER_EMAILID, USER_MSTR.USER_PASSWORD, USER_MSTR.USER_PSSWRD_EXPRY_DT, USER_MSTR.CREATED_DT, UM.ZONE_CODE, UM.CITY_ZONE_CODE, USER_MSTR.UPDATED_DT, USER_MSTR.CREATED_BY, USER_MSTR.UPDATED_BY , UM.ZONE_FLAG , USER_MSTR.STATUS,UM.CIRCLE_ID, USER_MSTR.GROUP_ID, USER_MSTR.KM_ACTOR_ID, USER_MSTR.KM_OWNER_ID, USER_MSTR.LOGIN_ATTEMPTED, USER_MSTR.LAST_LOGIN_TIME, USER_MSTR.USER_LOGIN_STATUS, USER_MSTR.FAV_CATEGORY_ID, USER_MSTR.ELEMENT_ID, UM.LOB_ID ,USER_MSTR.FAV_CATEGORY_ID,USER_MSTR.PARTNER_NAME,AC.KM_ACTOR_NAME ,(select CIRCLE_NAME FROM CIRCLE_MSTR WHERE CIRCLE_ID =UM.CIRCLE_ID AND LOB_ID = UM.LOB_ID ) AS CIRCLE_NAME ,(select ZONE_NAME FROM ZONE_MSTR WHERE ZONE_CODE = UM.ZONE_CODE) AS ZONE_NAME,(select CITY_ZONE_NAME FROM CITY_ZONE_MSTR WHERE CITY_ZONE_CODE = UM.CITY_ZONE_CODE) AS CITY_ZONE_NAME FROM USER_MSTR ,KM_ACTORS AC, USER_MAPPING UM WHERE USER_MSTR.KM_ACTOR_ID = AC.KM_ACTOR_ID AND USER_MSTR.USER_LOGIN_ID = UM.USER_LOGIN_ID AND USER_MSTR.USER_ID = ?  WITH UR";
	protected static final String SQL_SELECT_FOR_EDIT ="SELECT USER_MSTR.USER_ID, USER_MSTR.USER_LOGIN_ID, USER_MSTR.USER_FNAME, USER_MSTR.USER_MNAME, USER_MSTR.USER_LNAME,USER_MSTR.USER_MOBILE_NUMBER, USER_MSTR.USER_EMAILID, USER_MSTR.USER_PASSWORD, USER_MSTR.USER_PSSWRD_EXPRY_DT, USER_MSTR.CREATED_DT,USER_MSTR.UPDATED_DT,USER_MSTR.CREATED_BY, USER_MSTR.UPDATED_BY ,(select ZONE_ID FROM ZONE_MSTR WHERE ZONE_CODE = UM.ZONE_CODE) AS ZONE_CODE,(select CITY_ZONE_ID FROM CITY_ZONE_MSTR WHERE CITY_ZONE_CODE = UM.CITY_ZONE_CODE) as CITY_ZONE_CODE, UM.ZONE_FLAG , USER_MSTR.STATUS,UM.CIRCLE_ID, USER_MSTR.GROUP_ID, USER_MSTR.KM_ACTOR_ID, USER_MSTR.KM_OWNER_ID, USER_MSTR.LOGIN_ATTEMPTED, USER_MSTR.LAST_LOGIN_TIME, USER_MSTR.USER_LOGIN_STATUS, USER_MSTR.FAV_CATEGORY_ID, USER_MSTR.ELEMENT_ID, UM.LOB_ID ,USER_MSTR.FAV_CATEGORY_ID,USER_MSTR.PARTNER_NAME,AC.KM_ACTOR_NAME ,(select CIRCLE_MSTR_ID FROM CIRCLE_MSTR WHERE CIRCLE_ID =UM.CIRCLE_ID AND LOB_ID = UM.LOB_ID ),(select PRODUCT_LOB FROM  PRODUCT_LOB WHERE PRODUCT_LOB_ID = UM.LOB_ID), (select CIRCLE_NAME FROM CIRCLE_MSTR WHERE CIRCLE_ID =UM.CIRCLE_ID AND LOB_ID = UM.LOB_ID ) AS CIRCLE_NAME ,(select ZONE_NAME FROM ZONE_MSTR WHERE ZONE_CODE = UM.ZONE_CODE) AS ZONE_NAME,(select CITY_ZONE_NAME FROM CITY_ZONE_MSTR WHERE CITY_ZONE_CODE = UM.CITY_ZONE_CODE) AS CITY_ZONE_NAME FROM USER_MSTR ,KM_ACTORS AC, USER_MAPPING UM WHERE USER_MSTR.KM_ACTOR_ID = AC.KM_ACTOR_ID AND USER_MSTR.USER_LOGIN_ID = UM.USER_LOGIN_ID AND USER_MSTR.USER_ID = ?   AND UM.LOB_ID = ? WITH UR";

	protected static final String SQL_SELECT_USERS ="SELECT USER_MSTR.USER_ID, USER_MSTR.USER_LOGIN_ID, USER_MSTR.USER_FNAME, USER_MSTR.USER_MNAME, USER_MSTR.USER_LNAME, USER_MSTR.USER_MOBILE_NUMBER, USER_MSTR.USER_EMAILID, USER_MSTR.USER_PASSWORD, USER_MSTR.USER_PSSWRD_EXPRY_DT, USER_MSTR.CREATED_DT, USER_MSTR.CREATED_BY , USER_MSTR.UPDATED_DT, USER_MSTR.UPDATED_BY, USER_MSTR.STATUS, CIRCLE_MSTR.CIRCLE_NAME, USER_MSTR.GROUP_ID, KM_ACTORS.KM_ACTOR_NAME, USER_MSTR.KM_OWNER_ID, USER_MSTR.LOGIN_ATTEMPTED, USER_MSTR.LAST_LOGIN_TIME, USER_MSTR.USER_LOGIN_STATUS, USER_MSTR.FAV_CATEGORY_ID,USER_MSTR.PARTNER_NAME FROM USER_MSTR , CIRCLE_MSTR , KM_ACTORS WHERE  ";

	protected static final String SQL_SELECT_USERID ="SELECT USER_LOGIN_ID,ELEMENT_ID, USER_ID FROM USER_MSTR WHERE USER_LOGIN_ID = ?  ";

//Added BY Bhaskar
	
	protected static final String SQL_SELECT_USERFNAME ="SELECT USER_LOGIN_ID,ELEMENT_ID, USER_ID FROM USER_MSTR WHERE upper(USER_FNAME) = ? ";
	//end By Bhaskar
	protected static final String SQL_UPDATE_PWD ="UPDATE USER_MSTR SET USER_PASSWORD=?,UPDATED_DT=current timestamp,UPDATED_BY=?, USER_PSSWRD_EXPRY_DT =(current timestamp+45 DAYS), LAST_LOGIN_TIME=(current timestamp) WHERE USER_ID = ?";

	protected static final String SQL_SELECT_CIRCLE_APPROVER ="SELECT USER_MSTR.USER_ID, USER_MSTR.USER_LOGIN_ID, USER_MSTR.USER_FNAME, USER_MSTR.USER_MNAME, USER_MSTR.USER_LNAME, USER_MSTR.USER_MOBILE_NUMBER, USER_MSTR.USER_EMAILID, USER_MSTR.USER_PASSWORD, USER_MSTR.USER_PSSWRD_EXPRY_DT, USER_MSTR.CREATED_DT, USER_MSTR.CREATED_BY, USER_MSTR.UPDATED_DT, USER_MSTR.UPDATED_BY, USER_MSTR.STATUS, USER_MSTR.CIRCLE_ID, USER_MSTR.GROUP_ID, USER_MSTR.KM_ACTOR_ID, USER_MSTR.KM_OWNER_ID, USER_MSTR.LOGIN_ATTEMPTED, USER_MSTR.LAST_LOGIN_TIME, KM_CIRCLE_MSTR.CIRCLE_NAME FROM USER_MSTR, KM_CIRCLE_MSTR WHERE USER_MSTR.CIRCLE_ID = KM_CIRCLE_MSTR.CIRCLE_ID AND USER_MSTR.KM_ACTOR_ID = 2";

	protected static final String SQL_SELECT_CIRCLE_USER ="SELECT USER_MSTR.USER_ID, USER_MSTR.USER_LOGIN_ID, USER_MSTR.USER_FNAME, USER_MSTR.USER_MNAME, USER_MSTR.USER_LNAME, USER_MSTR.USER_MOBILE_NUMBER, USER_MSTR.USER_EMAILID, USER_MSTR.USER_PASSWORD, USER_MSTR.USER_PSSWRD_EXPRY_DT, USER_MSTR.CREATED_DT, USER_MSTR.CREATED_BY, USER_MSTR.UPDATED_DT, USER_MSTR.UPDATED_BY, USER_MSTR.STATUS, USER_MSTR.CIRCLE_ID, USER_MSTR.GROUP_ID, USER_MSTR.KM_ACTOR_ID, USER_MSTR.KM_OWNER_ID, USER_MSTR.LOGIN_ATTEMPTED, USER_MSTR.LAST_LOGIN_TIME, KM_CIRCLE_MSTR.CIRCLE_NAME FROM USER_MSTR, KM_CIRCLE_MSTR WHERE USER_MSTR.CIRCLE_ID = KM_CIRCLE_MSTR.CIRCLE_ID";
	...
	protected static final String SQL_UPDATE_USER_MAPPING ="UPDATE USER_MAPPING    SET  LOB_ID=?, CIRCLE_ID=?,  TRANSACTION_TIME=current timestamp, UPDATED_BY=?  WHERE USER_LOGIN_ID =? ";

	protected static final String SQL_DELETE_USER_MAPPING ="DELETE FROM USER_MAPPING  WHERE USER_LOGIN_ID =? AND LOB_ID = ? with UR";
	
	protected static final String SQL_UPDATE_USER_BULK ="UPDATE USER_MSTR SET  USER_FNAME = ?, USER_MNAME = ?, USER_LNAME = ?, USER_MOBILE_NUMBER = ?, USER_EMAILID = ?,   STATUS = 'A', UPDATED_BY = ?, UPDATED_DT = current timestamp ";
	...
	protected static final String SQL_GET_LOGIN_ATTEMPTED ="SELECT LOGIN_ATTEMPTED FROM USER_MSTR WHERE USER_LOGIN_ID = ? ";

	protected static final String UPDATE_LOGIN_ATTEMPTED ="update USER_MSTR set LOGIN_ATTEMPTED = LOGIN_ATTEMPTED+1 where USER_LOGIN_ID = ? ";
	...
	protected static final String SQL_GET_MANAGERS =" select * from USER_MSTR usr where status='A' and  user_id = ";
	...
	protected static final String SQL_GET_USERLOGIN_ID ="SELECT USER_LOGIN_ID FROM USER_MSTR WHERE USER_ID =? WITH UR";
	...
	*/
	...
	protected static final String SQL_INSERT_USER_MSTR = "INSERT INTO USER_MSTR(USER_ID, USER_LOGIN_ID, USER_FNAME, " +
			...
			"PASSWORD_RESET_TIME,OLM_ID) VALUES (NEXTVAL FOR KM_USER_ID_SEQ,?,?,?,?,?,?,?,current timestamp + 45 days, current timestamp,?," +
			"null,null,'A',?,0,null,'N',?,current timestamp,?)";
	
	protected static final String SQL_INSERT_USER_MAPPING_DATA = "INSERT INTO USER_MAPPING(USER_LOGIN_ID, LOB_ID, CIRCLE_ID, " +
	...
	protected static final String LAST_THREE_PASSWORD_CHECK="Select count(b.USER_PASSWORD) as matches from USER_MSTR a, PASSWORD_HISTORY b where a.USER_LOGIN_ID = ?  and b.USER_PASSWORD = ? and b.USER_LOGIN_ID = a.USER_LOGIN_ID  WITH UR";
...
private static UserMstrDaoImpl userMstrDaoImpl=null;
	...
	public int insert(UserMstr dto) throws LMSException {
		...
		try {
			...
			if(actorId==7){
				ps = con.prepareStatement("SELECT COUNT(*) AS COUNT FROM USER_MSTR WHERE ELEMENT_ID = ? and KM_ACTOR_ID = ? WITH UR");
	...
	public void insertBulkDataTransactionLogs(UserMstr dto)throws LMSException{
		...
		logger.info(dto.getUserLoginId()+dto.getMessage()+dto.getIpaddress()+dto.getFileName());
	...
	public int update(UserMstr dto) throws LMSException {
		...
		try {
			...
			ps2 = con.prepareStatement(query1.append(" with ur").toString());
			...
			logger.info("role--------------"+Integer.parseInt(dto.getKmActorId()));
			...
			if (dto.getSelectedTypeId() == 2){				
				ps4 = con.prepareStatement(query2.append(" with ur ").toString());
...
/*						if(i==0 && multipleCircles.length > 1)
						...
						for(int j=0 ; j < circleForUserList.size(); j++){
							...
							logger.info("intcircles"+intcircles);
	...
	public boolean CheckUserId(String userLoginId) throws DAOException,LMSException {
		...
		try {
			StringBuffer query= new StringBuffer("SELECT USER_ID FROM USER_MSTR WHERE USER_LOGIN_ID = ? AND STATUS = 'A' WITH UR"); // AND STATUS = 'A'
			//String sql =
	...
	public UserDto selectUser(String userId, String loginActorId) throws LMSException {
		...
		try {
			...
			while (rs.next()) 
			{
				...
				ps1 = con.prepareStatement(sql.append("  with ur ").toString());
	...
	/* Modified By Parnika Nov - 2013 for Inserting User Data in User Master and User Mapping for LMS Phase 2 */
	public int insertUserData(UserMstr user) throws DAOException,LMSException {
		...
		try {
			...
			if (user.getCircleId() != null && !(user.getCircleId().trim().equalsIgnoreCase(""))){
				
				circleId = master.getCircleIdValue(Integer.parseInt(user.getCircleId()));
			}
			else{
				circleId = Integer.parseInt(Constants.PANINDIA_CIRCLE_ID);
			}
			
			if (!(user.getKmActorId().equalsIgnoreCase(Constants.CIRCLE_COORDINATOR_ACTOR))){
				...
				multipleCircles = user.getCreateMultiple();				
				if(multipleCircles != null)
				{
					for(int i =0 ; i< multipleCircles.length ; i++)
					{
/*						if(i==0 && multipleCircles.length > 1)
	...
	/* End of changes by Parnika for LMS Phase 2*/
		...
		try {
			...
			logger.info("userMstrDto.getUserLoginId() : "+userMstrDto.getUserLoginId());
			String loginStatusUpdateQuery="update USER_MSTR set USER_LOGIN_STATUS = ? where USER_LOGIN_ID = ?  WITH UR" ;
			ps.clearParameters();
	...
	public void updateSessionExpiry(UserMstr userMstrDto) throws LMSException {
		...
		try {
			...
			query=("UPDATE USER_MSTR SET SESSION_EXPIRY_TIME = current timestamp + 5 minute WHERE USER_ID = ? with ur");
	...
	public String getUserStatus(String userLoginId) throws LMSException {
		...
		String status="";
		try {
			String sql ="SELECT STATUS,KM_ACTOR_ID,USER_LOGIN_STATUS FROM USER_MSTR WHERE USER_LOGIN_ID = ? with ur";
			con = DBConnection.getDBConnection();
	...
	public UserMstr CheckUserLoginId(String user_login_id) throws LMSException, DAOException {
		...
		try {
			StringBuffer query= new StringBuffer(SQL_SELECT_USERID);
			//String sql =
			query.append(" WHERE USER_MSTR.USER_LOGIN_ID = ?  ").toString();
			con = DBConnection.getDBConnection();
			pst = con.prepareStatement(query.append(" with ur ").toString());
			pst.setString(1, user_login_id);
			rs = pst.executeQuery();
	...
	public UserMstr userIdFromMobile(String mobileNumber) throws DAOException {
		...
		try {
			String query= "SELECT USER_ID,USER_LOGIN_ID,ELEMENT_ID,USER_FNAME,USER_LNAME FROM USER_MSTR WHERE KM_ACTOR_ID IN (2,1) AND USER_MOBILE_NUMBER = ? AND STATUS = 'A'   WITH UR";
	...
	public UserMstr userIdFromMobile(String mobileNumber,String actorIDs) throws DAOException {
		...
		try {
			...
			"FROM USER_MSTR UM, KM_CIRCLE_MSTR CM  WHERE UM.CIRCLE_ID=CM.CIRCLE_ID  and KM_ACTOR_ID IN ("+actorIDs+") AND "+
...

	{
		...
		try
		{
			...
			CircleMstrDto dto;
			con = DBConnection.getDBConnection();
			ps = con.prepareStatement(query.append("order by lower(CIRCLE_NAME)  with ur").toString());
	...
	public boolean CheckUserIdBasedOnLobAndCircle(String userLoginId, String lobId, String actorId) throws DAOException,LMSException {
		...
		boolean isExist = false;
		try {
			StringBuffer query= new StringBuffer("SELECT um.USER_ID FROM USER_MSTR um, USER_MAPPING umap WHERE um.USER_LOGIN_ID = umap.USER_LOGIN_ID AND um.STATUS = 'A' AND um.USER_LOGIN_ID = ? and umap.LOB_ID = ? "); 
			con = DBConnection.getDBConnection();
			pst = con.prepareStatement(query.append(" with ur ").toString());
			pst.setString(1, userLoginId);
	...
	public boolean checkActorForUserLogin(String userLoginId, String actorId) throws DAOException,LMSException {
		...
		try {
			StringBuffer query= new StringBuffer("SELECT um.USER_ID, um.KM_ACTOR_ID FROM USER_MSTR um, USER_MAPPING umap WHERE um.USER_LOGIN_ID = umap.USER_LOGIN_ID AND um.STATUS = 'A' AND um.USER_LOGIN_ID = ? "); 
			con = DBConnection.getDBConnection();
			pst = con.prepareStatement(query.append(" with ur ").toString());
			pst.setString(1, userLoginId);
			rs = pst.executeQuery();
	...
	throws DAOException {
			...
			try {
				...
				con = DBConnection.getDBConnection();
				ps = con.prepareStatement("SELECT * FROM USER_MSTR UM,USER_MAPPING UMP WHERE UM.USER_LOGIN_ID=UMP.USER_LOGIN_ID and UM.STATUS='A' and UMP.LOB_ID=? and UM.USER_LOGIN_ID=? with ur");
			...
			try {
				// 
				con = DBConnection.getDBConnection();
				ps = con.prepareStatement("SELECT * FROM USER_MAPPING WHERE USER_LOGIN_ID=? and LOB_ID=? and CIRCLE_ID=? with ur");
				ps.setString(1,userLoginId);
	...
	public ArrayList insertBulkUserData(ArrayList<UserMstr> userList) throws DAOException 
	{
		...
		{	
			...
			String sql ="SELECT USER_LOGIN_ID FROM USER_MSTR WHERE USER_LOGIN_ID=? with ur";
			String sql1="SELECT CZM.CITY_ZONE_CODE, CZM.CITY_CODE, CM.ZONE_CODE FROM CITY_ZONE_MSTR CZM, CITY_MSTR CM, ZONE_MSTR ZM , CIRCLE_MSTR CIM WHERE ucase(CZM.CITY_ZONE_CODE)=? AND CZM.CITY_CODE = CM.CITY_CODE AND CM.ZONE_CODE = ZM.ZONE_CODE AND ZM.CIRCLE_MSTR_ID = CIM.CIRCLE_MSTR_ID AND CIM.LOB_ID =? AND CIM.CIRCLE_ID = ? WITH UR ";
			con = DBConnection.getDBConnection();
			con.setAutoCommit(false);
			ps = con.prepareStatement(query.append(" with ur").toString());
...
public void updateBulkUserCreation(UserMstr bulkDto) throws DAOException {
		...
		{	
			...
			//updated query
			StringBuffer UPDATE_USER_MASTER = new StringBuffer("UPDATE USER_MSTR SET ");
			
//			Iterator<UserMstr> itr=listBulkDto.iterator();
//			while(itr.hasNext())
//			{
//				UserMstr dt=itr.next();
//				//logger.info("update query"+UPDATE_USER_MASTER);
//				logger.info("1st field"+dt.getUserFname());
//				logger.info("2nd field"+dt.getUserMname());
//				logger.info("3rd field"+dt.getUserEmailid());
//				
//				
//			}
