...
public class MasterDaoImpl implements MasterDao {
	protected static final String SQL_SELECT_PRODUCT_MSTR ="SELECT PRODUCT_ID, PRODUCT_LOB_ID, PRODUCT_NAME, PRODUCT_DESC, PRODUCT_HEAD_OLM_ID FROM PRODUCT_MSTR WHERE STATUS='A' WITH UR";
	protected static final String SQL_SELECT_STATE_MSTR ="SELECT STATE_ID,STATE_CODE , STATE_NAME, STATE_DESC FROM STATE_MSTR WITH UR";
	protected static final String SQL_SELECT_CIRCLE_MSTR ="SELECT CIRCLE_ID, CIRCLE_NAME, CIRCLE_DESC FROM CIRCLE_MSTR WHERE CIRCLE_ID > 0 WITH UR";
	protected static final String SQL_SELECT_CIRCLE_FOR_PRODUCT ="SELECT CIRCLE_ID, LOB_ID, CIRCLE_MSTR_ID, CIRCLE_NAME, CIRCLE_DESC FROM CIRCLE_MSTR WHERE CIRCLE_ID > 0 AND LOB_ID=? AND STATUS='A' ORDER BY CIRCLE_NAME WITH UR";
	protected static final String SQL_SELECT_LOB_MSTR ="SELECT PRODUCT_LOB_ID, PRODUCT_LOB FROM PRODUCT_LOB WHERE STATUS = 'A' WITH UR";
	protected static final String SQL_SELECT_USER_CIRCLE_MSTR ="SELECT CIRCLE_ID, CIRCLE_NAME, CIRCLE_DESC FROM CIRCLE_MSTR WHERE CIRCLE_ID >= 0 WITH UR";
	protected static final String SQL_SELECT_LOB_ID ="SELECT PRODUCT_LOB_ID, PRODUCT_LOB FROM PRODUCT_LOB WHERE PRODUCT_LOB = ? AND STATUS = 'A' WITH UR";
	protected static final String SQL_SELECT_REQUEST_TYPE_MSTR ="SELECT  REQUEST_ID, REQUEST_TYPE FROM REQUEST_TYPE_MSTR WITH UR";
	
	//ADDED BY NANCY AGRAWAL.
	protected static final String SQL_SELECT_ALERT_MSTR="SELECT ALERT_ID,ALERT_NAME FROM ALERT_EMAIL_MASTER WITH UR";
	...
	protected static final String SQL_SELECT_LEAD_SUB_STATUSCODE="SELECT UNIQUE_ID FROM LEAD_SUB_STATUS WHERE LEAD_STATUS_ID=? AND SUB_STATUS_ID=? AND PRODUCT_LOB_ID=? with ur";
	
	protected static final String SQL_SELECT_SOURCE_MSTR ="SELECT SOURCE_ID, SOURCE_NAME FROM SOURCE_MSTR WITH UR";
	protected static final String SQL_SELECT_SUB_SOURCE_MSTR ="SELECT SUBSOURCE_ID, SUBSOURCE_NAME FROM SUB_SOURCE_MSTR WITH UR";
	protected static final String SQL_SELECT_ZONE_MSTR ="select ZONE_ID,ZONE_CODE, ZONE_NAME,CITY_CODE from ZONE_MSTR WITH UR";
	protected static final String SQL_SELECT_RSU_MSTR ="select RSU_ID, RSU_CODE, CITY_ZONE_CODE from RSU_MSTR WITH UR";
	protected static final String SQL_SELECT_CITY_MSTR ="select CITY_ID,CITY_CODE ,CITY_NAME,CIRCLE_ID from CITY_MSTR WITH UR";
	protected static final String SQL_SELECT_LEAD_STATUS ="SELECT LEAD_STATUS_ID, LEAD_STATUS, LEAD_STATUS_NAME FROM LEAD_STATUS WITH UR";
	protected static final String SQL_SELECT_LEAD_STATUS_NAME="SELECT LEAD_STATUS FROM LEAD_STATUS WHERE LEAD_STATUS_ID=? WITH UR";
	
	
	protected static final String SQL_VALIDATE_ZONE_CODE = "select ZONE_CODE from ZONE_MSTR where ZONE_CODE=? and CIRCLE_MSTR_ID= (select CIRCLE_MSTR_ID from CIRCLE_MSTR where CIRCLE_ID=?  and LOB_ID=? ) WITH UR";
	...
	protected static final String SQL_VALIDATE_CIRCLE_ID = "SELECT CIRCLE_ID FROM CIRCLE_MSTR WHERE CIRCLE_ID = ? AND LOB_ID=? AND CIRCLE_ID >= 0 WITH UR";
	protected static final String SQL_VALIDATE_USER_CIRCLE_ID = "SELECT CIRCLE_ID FROM CIRCLE_MSTR WHERE CIRCLE_ID = ? WITH UR";
	
	protected static final String SQL_VALIDATE_CITY_CODE = "SELECT CITY_CODE FROM CITY_MSTR WHERE CITY_CODE = ? AND ZONE_CODE = ? WITH UR";
	//protected static final String SQL_VALIDATE_ZONE_CODE = "SELECT ZONE_CODE FROM ZONE_MSTR WHERE ZONE_CODE = ? AND CITY_CODE = ? WITH UR";
	protected static final String SQL_VALIDATE_RSU_CODE = "SELECT RSU_CODE FROM RSU_MSTR WHERE RSU_CODE = ? AND CITY_ZONE_CODE = ? WITH UR";
	protected static final String SQL_VALID_RSU_CODE = "SELECT RSU_CODE FROM RSU_MSTR WHERE RSU_CODE = ? WITH UR";
	//Query changed by Neetika for LMS phase -2 for valdiation of pin code with city zone coe//reverted back
	protected static final String SQL_VALIDATE_PINCODE = "SELECT PINCODE FROM PINCODE_MSTR WHERE PINCODE = ? AND CITY_ZONE_CODE = ? WITH UR";
	//protected static final String SQL_VALIDATE_PINCODE = "SELECT PINCODE FROM PINCODE_MSTR WHERE PINCODE = ? AND CITY_ZONE_CODE = ? WITH UR";
	protected static final String SQL_VALIDATE_PRODUCT_ID = "SELECT PRODUCT_ID FROM PRODUCT_MSTR WHERE PRODUCT_ID = ? AND STATUS = 'A' WITH UR";
	protected static final String SQL_VALIDATE_USER_LOGIN_ID = "SELECT USER_LOGIN_ID FROM USER_MSTR WHERE USER_LOGIN_ID = ? WITH UR";
	protected static final String SQL_VALIDATE_PRODUCT_LOB_ID = "SELECT PRODUCT_LOB_ID FROM PRODUCT_LOB WHERE PRODUCT_LOB_ID = ? WITH UR";
	protected static final String SQL_VALIDATE_STATE_CODE ="SELECT STATE_CODE FROM STATE_MSTR WHERE STATE_CODE = ? WITH UR";
	protected static final String SQL_VALIDATE_REQUEST_ID ="SELECT REQUEST_ID FROM REQUEST_TYPE_MSTR WHERE REQUEST_ID = ? WITH UR";
	protected static final String SQL_VALIDATE_SOURCE_ID ="SELECT SOURCE_ID FROM SOURCE_MSTR WHERE SOURCE_ID = ? WITH UR";
	protected static final String SQL_VALIDATE_SUB_SOURCE_ID ="SELECT SUBSOURCE_ID FROM SUB_SOURCE_MSTR WHERE SUBSOURCE_ID = ? WITH UR";
	protected static final String SQL_VALIDATE_ACTOR_ID = "SELECT KM_ACTOR_ID FROM KM_ACTORS WHERE KM_ACTOR_ID = ? WITH UR";
	protected static final String SQL_VALIDATE_PRODUCT_ID_NAME="SELECT PRODUCT_ID FROM PRODUCT_MSTR WHERE PRODUCT_ID = ? AND  PRODUCT_LOB_ID=? WITH UR";
	protected static final String SQL_SELECT_LEAD_STATUS_CC ="SELECT LEAD_STATUS_ID, LEAD_STATUS, LEAD_STATUS_NAME FROM LEAD_STATUS WHERE LEAD_STATUS IN ('LEAD_OPEN','QUALIFIED')  WITH UR";
	protected static final String SQL_SELECT_LEAD_STATUS_DIALLER ="SELECT LEAD_STATUS_ID, LEAD_STATUS, LEAD_STATUS_NAME FROM LEAD_STATUS WHERE LEAD_STATUS IN ('QUALIFIED','QUALIFICATION_LOST','LEAD_CALLBACK')  WITH UR";
	protected static final String SQL_SELECT_PINCODE_MSTR ="SELECT PINCODE from PINCODE_MSTR where STATUS = 'A' WITH UR";
	protected static final String SQL_SELECT_TELEMEDIA_PRODUCT ="SELECT P.PRODUCT_ID,P.PRODUCT_NAME,P.PRODUCT_LOB_ID,PL.PRODUCT_LOB from PRODUCT_MSTR P ,PRODUCT_LOB PL  where P.PRODUCT_LOB_ID = PL.PRODUCT_LOB_ID and   PL.PRODUCT_LOB like '%Telemedia%' and PL.STATUS = 'A' and P.STATUS='A' WITH UR";
	protected static final String SQL_SELECT_MOBILITY_PRODUCT ="SELECT PRODUCT_ID,PRODUCT_NAME from PRODUCT_MSTR where PRODUCT_LOB_ID = (SELECT PRODUCT_LOB_ID from PRODUCT_LOB where PRODUCT_LOB like '%Mobility%' and status = 'A') and status = 'A' WITH UR";
	protected static final String SQL_SELECT_DTH_PRODUCT ="SELECT PRODUCT_ID from PRODUCT_MSTR where PRODUCT_LOB_ID = (SELECT PRODUCT_LOB_ID from PRODUCT_LOB where UPPER(PRODUCT_LOB) like UPPER('%DTH%') and status = 'A') and status = 'A' WITH UR";
	protected static final String SQL_SELECT_CITY_FOR_CIRCLE = "select CITY_ID,CITY_CODE ,CITY_NAME,ZONE_CODE from CITY_MSTR WHERE ZONE_CODE in (SELECT ZONE_CODE FROM ZONE_MSTR WHERE CIRCLE_MSTR_ID=? WITH UR) AND STATUS='A' ORDER BY CITY_NAME WITH UR";
	protected static final String SQL_SELECT_CITY_FOR_ZONE = "select CITY_ID,CITY_CODE ,CITY_NAME,CIRCLE_ID from CITY_MSTR WHERE CITY_CODE = ? WITH UR";
	protected static final String SQL_SELECT_CITY_ZONE_FOR_CITY = "SELECT  CITY_ZONE_ID,CITY_ZONE_CODE,CITY_ZONE_NAME FROM CITY_ZONE_MSTR WHERE CITY_CODE=? AND STATUS='A' ORDER BY CITY_ZONE_NAME WITH UR";
	protected static final String SQL_SELECT_ZONE_FOR_CIRCLE = "select ZONE_CODE,ZONE_NAME from ZONE_MSTR where CIRCLE_MSTR_ID = ? WITH UR";
	protected static final String SQL_SELECT_PIN_FOR_CITY = "SELECT PINCODE from PINCODE_MSTR where STATUS = 'A' AND CITY_CODE = ? WITH UR";
	protected static final String SQL_SELECT_ZONE_FOR_CITY ="select ZONE_ID,ZONE_CODE, ZONE_NAME from ZONE_MSTR WHERE ZONE_CODE = ? AND STATUS='A' WITH UR";
	protected static final String SQL_SELECT_CITY_FOR_PIN ="SELECT CITY_CODE,CITY_NAME FROM CITY_MSTR WHERE CITY_CODE = (SELECT CITY_CODE FROM PINCODE_MSTR WHERE PINCODE=? AND STATUS = 'A') WITH UR";
	protected static final String SQL_SELECT_RSU_FOR_ZONE = "SELECT RSU_ID, RSU_CODE FROM RSU_MSTR WHERE ZONE_CODE = ? AND STATUS = 'A' WITH UR";
	protected static final String SQL_SELECT_PRODUCT_LOB_MSTR = "SELECT PRODUCT_LOB, PRODUCT_LOB_ID FROM PRODUCT_LOB where status='A' WITH UR";
	/*Added By amarjeet */
	protected static final String SQL_SELECT_ZONE_FOR_CITY_DIALER ="select ZONE_CODE from CITY_MSTR WHERE CITY_CODE = ? AND STATUS='A' WITH UR";
	protected static final String SQL_SELECT_CIRCLE_FOR_USER ="SELECT CM.CIRCLE_NAME, CM.CIRCLE_ID, (SELECT PRODUCT_LOB FROM PRODUCT_LOB WHERE PRODUCT_LOB_ID = UM.LOB_ID)  FROM CIRCLE_MSTR CM , USER_MAPPING UM  WHERE UM.USER_LOGIN_ID = ? and UM.CIRCLE_ID =CM.CIRCLE_ID AND CM.LOB_ID = UM.LOB_ID WITH UR";
	protected static final String SQL_SELECT_LOB_FOR_USER ="SELECT DISTINCT(PL.PRODUCT_LOB), PL.PRODUCT_LOB_ID FROM USER_MAPPING UM , PRODUCT_LOB PL WHERE USER_LOGIN_ID = ?  AND UM.LOB_ID = PL.PRODUCT_LOB_ID WITH UR";
	protected static final String SQL_SELECT_LOB_LIST_FOR_USER ="SELECT DISTINCT(PL.PRODUCT_LOB), PL.PRODUCT_LOB_ID FROM USER_MAPPING UM , PRODUCT_LOB PL WHERE USER_LOGIN_ID = ? AND UM.LOB_ID = PL.PRODUCT_LOB_ID WITH UR";
	protected static final String SQL_SELECT_CIRCLE_FOR_USER_LOB ="SELECT DISTINCT(CM.CIRCLE_NAME), CM.CIRCLE_ID FROM CIRCLE_MSTR CM , USER_MAPPING UM  WHERE UM.USER_LOGIN_ID = ? and um.CIRCLE_ID =CM.CIRCLE_ID AND UM.LOB_ID =? WITH UR";
	protected static final String SQL_SELECT_CHANNEL_PARTNER="SELECT USER.USER_FNAME , USER.USER_LNAME , USER.USER_LOGIN_ID , USER.PARTNER_NAME FROM USER_MSTR USER , USER_MAPPING MAPPING , CIRCLE_MSTR CM WHERE USER.KM_ACTOR_ID = ? AND MAPPING.LOB_ID = CM.LOB_ID AND USER.USER_LOGIN_ID = MAPPING.USER_LOGIN_ID  AND MAPPING.CIRCLE_ID = CM.CIRCLE_ID AND CM.LOB_ID = ? AND CM.CIRCLE_MSTR_ID = ? order by USER_FNAME WITH UR ";
	...
	protected static final String SQL_ZONE_ID ="select ZONE_ID  from ZONE_MSTR where ZONE_CODE = ? with ur";
	protected static final String SQL_CITY_ZONE_ID ="select CITY_ZONE_ID  from CITY_ZONE_MSTR where CITY_ZONE_CODE = ?  WITH UR";
	protected static final String SQL_CITY_ZONE_CODE ="select CITY_ZONE_CODE  from CITY_ZONE_MSTR where CITY_ZONE_ID = ?  WITH UR";
	protected static final String SQL_ZONE_CODE ="select ZONE_CODE  from ZONE_MSTR where ZONE_ID = ? with ur";
	protected static final String SQL_SELECT_PARAMETER = "SELECT PARAM_NAME FROM PARAMETER_MASTER WHERE ucase(FORM_NAME) = ucase(?) AND STATUS = 'A' WITH UR";
	
	/*Added By amarjeet */
	/*Added By Bhaskar */
	protected static final String SQL_SELECT_CIRCLE_FOR_PRODUCTLOB="SELECT CIRCLE_ID,CIRCLE_NAME FROM CIRCLE_MSTR WHERE CIRCLE_ID > 0 AND LOB_ID=? AND STATUS='A' WITH UR "; 
	protected static final String SQL_VALIDATE_RSUCODE_NEW="SELECT RSU_CODE  FROM RSU_MSTR WHERE  RSU_CODE=? AND CITY_ZONE_CODE=? WITH UR";
	protected static final String SQL_VALIDATE_PINCODE_NEW=" SELECT PINCODE  FROM PINCODE_MSTR WHERE  PINCODE=? AND CITY_ZONE_CODE=? WITH UR ";
	protected static final String SQL_VALIDATE_CITY_ID_NEW="SELECT CITY_CODE FROM CITY_MSTR WHERE CITY_CODE=? AND ZONE_CODE=? WITH UR";
	protected static final String SQL_VALIDATE_ZONEID_NEW="select ZONE_CODE from ZONE_MSTR where ZONE_CODE=? and CIRCLE_MSTR_ID=(select CIRCLE_MSTR_ID from CIRCLE_MSTR where CIRCLE_ID=? and LOB_ID=(select PRODUCT_LOB_ID from PRODUCT_MSTR where PRODUCT_ID=?)) WITH UR";
	protected static final String SQL_VALIDATE_CIRCLE_ID_NEW="SELECT CIRCLE_ID FROM CIRCLE_MSTR WHERE CIRCLE_ID = ? AND LOB_ID=? AND CIRCLE_ID > 0 WITH UR ";
	...
	protected static final String SQL_PRODUCT_LOB_NEW="SELECT PRODUCT_LOB_ID,PRODUCT_LOB from PRODUCT_LOB where PRODUCT_LOB_ID=? AND STATUS='A' WITH UR ";
	/* Added By Parnika */
	protected static final String SQL_SELECT_LOG_TYPE = "SELECT REPORT_ID, REPORT_NAME FROM REPORT_MSTR WHERE REPORT_STATUS = 'L' WITH UR";
	protected static final String SQL_SELECT_REPORT_TYPE = "SELECT REPORT_ID, REPORT_NAME FROM REPORT_MSTR WHERE REPORT_STATUS = 'A' WITH UR";
	protected static final String SQL_SELECT_REPORT_TYPE_DAY_MONTHLY = "SELECT REPORT_ID, REPORT_NAME FROM REPORT_MSTR WHERE REPORT_STATUS = 'P' WITH UR";
	
	
	protected static final String SQL_SELECT_REPORT_NAME = "SELECT REPORT_NAME FROM REPORT_MSTR WHERE REPORT_ID = ? WITH UR";
	protected static final String SQL_SELECT_MASTER_TYPE = "SELECT MASTER_NAME, MASTER_ID FROM MASTER_DATA WHERE MASTER_STATUS = 'A' WITH UR";
	protected static final String SQL_SELECT_ACTOR = "SELECT KM_ACTOR_ID, KM_ACTOR_NAME  FROM KM_ACTORS WHERE  KM_ACTOR_ID > ? WITH UR";
	protected static final String SQL_SELECT_ACTOR_FOR_USERCREATION = "SELECT KM_ACTOR_ID, KM_ACTOR_NAME  FROM KM_ACTORS WHERE  KM_ACTOR_ID != ? AND KM_ACTOR_ID NOT IN ("+Constants.KM_SUPERADMIN_ACTOR_ID+","+Constants.KM_PANINDIA_USER_ACTOR_ID+","+Constants.KM_ACTOR_ID+") WITH UR";
	...
	//Added By Bhaskar
	protected static final String SQL_SELECT_MOBILITY_PRODUCT_NEW="SELECT P.PRODUCT_ID,P.PRODUCT_NAME,P.PRODUCT_LOB_ID,PL.PRODUCT_LOB from PRODUCT_MSTR P ,PRODUCT_LOB PL  where P.PRODUCT_LOB_ID = PL.PRODUCT_LOB_ID and   PL.PRODUCT_LOB like '%Mobility%' and PL.STATUS = 'A' and P.STATUS='A' WITH UR";
	protected static final String SQL_SELECT_OTHERS_PRODUCT="SELECT P.PRODUCT_ID,P.PRODUCT_NAME,P.PRODUCT_LOB_ID,PL.PRODUCT_LOB from PRODUCT_MSTR P ,PRODUCT_LOB PL  where P.PRODUCT_LOB_ID = PL.PRODUCT_LOB_ID and   PL.PRODUCT_LOB_ID NOT IN (1,2)  and PL.STATUS = 'A' and P.STATUS='A' WITH UR";
	protected static final String SQL_VALIDATE_CAMPAIGN_FIELD="SELECT LEAD_CAMPAIGN_NAME FROM LEAD_CAMPAIGN_DETAIL WHERE LEAD_CAMPAIGN_NAME =? WITH UR";
	...
	protected static final String SQL_VALIDATE_ZONE_CIRCLE = "select ZONE_CODE from ZONE_MSTR where zone_code=? and CIRCLE_MSTR_ID= (select CIRCLE_MSTR_ID from CIRCLE_MSTR where CIRCLE_ID=? and LOB_ID=(select " +
			"PRODUCT_LOB_ID from PRODUCT_MSTR where PRODUCT_ID=?)) with ur";
	
	protected static final String SQL_VALIDATE_CITY_FROM_ZONE = "select CITY_CODE  from CITY_MSTR where ZONE_CODE=? and CITY_CODE=? with ur";
	protected static final String SQL_VALIDATE_CITY_ZONE_CODE = "select CITY_ZONE_CODE from CITY_ZONE_MSTR where CITY_ZONE_CODE=? and CITY_CODE=? with ur";
	protected static final String SQL_VALIDATE_ZONE_CIRCLE_REVERSE = " select CL.CIRCLE_ID, PM.PRODUCT_ID from (select CIRCLE_ID,LOB_ID from CIRCLE_MSTR where CIRCLE_MSTR_ID in(select CIRCLE_MSTR_ID from ZONE_MSTR where zone_code in ( " +
			...
			"CL.LOB_ID=PM.PRODUCT_LOB_ID  and PM.PRODUCT_ID=? with ur ";
	...
	protected static final String SQL_VALIDATE_PIN_REVERSE="select CL.CIRCLE_ID, PM.PRODUCT_ID from (select CIRCLE_ID,LOB_ID from CIRCLE_MSTR where CIRCLE_MSTR_ID in(select CIRCLE_MSTR_ID from ZONE_MSTR where zone_code in (" +
			...
			" CL.LOB_ID=PM.PRODUCT_LOB_ID  and PM.PRODUCT_ID=? with ur";
	protected static final String SQL_VALIDATE_CIRCLE_ID_PROD = "SELECT CIRCLE_ID FROM CIRCLE_MSTR WHERE CIRCLE_ID = ? AND LOB_ID=(select PRODUCT_LOB_ID from product_mstr where product_id=?) AND CIRCLE_ID > 0 WITH UR";
	//end
	
	/* Added by Parnika for LMS Phase 2 */	
	
	protected static final String SQL_SELECT_CIRCLE_LOB_MSTR = "SELECT CIRCLE_NAME, CIRCLE_MSTR_ID , CIRCLE_ID FROM CIRCLE_MSTR WHERE STATUS = 'A' AND LOB_ID = ? AND CIRCLE_ID >= 0 WITH UR";
	protected static final String SQL_SELECT_CIRCLE_LOB_MSTR_ALL = "SELECT CIRCLE_NAME, CIRCLE_MSTR_ID , CIRCLE_ID FROM CIRCLE_MSTR WHERE STATUS = 'A' AND CIRCLE_ID >= 0 WITH UR";
	
	protected static final String SQL_SELECT_CIRCLE_ZONE_MSTR = "SELECT ZONE_CODE , ZONE_NAME as ZONE_NAME FROM ZONE_MSTR WHERE STATUS = 'A' AND CIRCLE_MSTR_ID = ? WITH UR";
	...
	protected static final String SQL_SELECT_CIRCLE_CITY_ZONE_MSTR = "SELECT cz.CITY_ZONE_ID as ZONE_CODE, cz.CITY_ZONE_NAME as ZONE_NAME FROM CITY_ZONE_MSTR cz , CIRCLE_MSTR cm, ZONE_MSTR zm , CITY_MSTR cim WHERE cm.CIRCLE_MSTR_ID = zm.CIRCLE_MSTR_ID AND zm.ZONE_CODE = cim.ZONE_CODE AND cim.CITY_CODE = cz.CITY_CODE AND cz.STATUS = 'A' AND cm.CIRCLE_MSTR_ID = ? WITH UR";	
	protected static final String SQL_SELECT_CITY_CODE_MSTR = "SELECT CITY_CODE, CITY_NAME FROM CITY_MSTR WHERE STATUS = 'A' AND ZONE_CODE = ? WITH UR";	
	protected static final String SQL_SELECT_CITY_ZONE_CODE_MSTR = "SELECT CITY_ZONE_CODE, CITY_ZONE_NAME FROM CITY_ZONE_MSTR WHERE STATUS = 'A' AND CITY_CODE = ? WITH UR";	
	protected static final String SQL_SELECT_PINCODE_CITYZONE_MSTR = "SELECT PINCODE FROM PINCODE_MSTR WHERE STATUS = 'A' AND CITY_ZONE_CODE = ? WITH UR";	
	protected static final String SQL_SELECT_RSU_CITYZONE_MSTR = "SELECT RSU_ID, RSU_CODE FROM RSU_MSTR WHERE STATUS = 'A' AND CITY_ZONE_CODE = ? WITH UR";	
	protected static final String SQL_GET_CIRCLE_ID = "SELECT CIRCLE_ID FROM CIRCLE_MSTR WHERE CIRCLE_MSTR_ID = ? WITH UR";
	protected static final String SQL_GET_CIRCLE_MSTR_ID = "SELECT CIRCLE_MSTR_ID FROM CIRCLE_MSTR WHERE CIRCLE_ID = ? AND LOB_ID=? WITH UR";
	protected static final String SQL_SELECT_CIRCLE_ZONE_TYPE_MSTR = "SELECT ZONE_ID as ZONE_CODE , ZONE_NAME as ZONE_NAME FROM ZONE_MSTR WHERE STATUS = 'A' AND CIRCLE_MSTR_ID = ? WITH UR";
	...
	protected static final String SQL_SELECT_CIRCLE_LOB_MSTR_NEW_USER="SELECT C.CIRCLE_ID,C.CIRCLE_NAME from USER_MAPPING U,CIRCLE_MSTR C where U.LOB_ID=? AND U.USER_LOGIN_ID=? AND U.LOB_ID=C.LOB_ID AND U.CIRCLE_ID=C.CIRCLE_ID WITH UR";
	protected static final String SQL_SELECT_CIRCLE_LOB_MSTR_NEW="SELECT C.CIRCLE_MSTR_ID,C.CIRCLE_NAME from USER_MAPPING U,CIRCLE_MSTR C where U.LOB_ID=? AND U.USER_LOGIN_ID=? AND U.LOB_ID=C.LOB_ID AND U.CIRCLE_ID=C.CIRCLE_ID WITH UR";
	protected static final String SQL_SELECT_CIRCLE_ID_NEWONE="SELECT C.CIRCLE_ID FROM USER_MAPPING U,CIRCLE_MSTR C where C.CIRCLE_ID=? AND C.LOB_ID=? AND U.USER_LOGIN_ID=? AND U.LOB_ID=C.LOB_ID AND U.CIRCLE_ID=C.CIRCLE_ID WITH UR";
	/* End of changes by Parnika */
	
	// <Added by Sudhanshu 
	public static final String SQL_SELECT_RSU = "select RSU_CODE from RSU_MSTR where RSU_CODE = ? with ur";
	
	protected static final String SQL_SELECT_USERDOWNLOADREPORT_NAME_CIRCLECOORDINATOR="SELECT U.USER_LOGIN_ID,UM.CIRCLE_ID,U.USER_FNAME,U.USER_MNAME,U.USER_LNAME,U.ROLE,U.USER_EMAILID,U.USER_MOBILE_NUMBER,U.PARTNER_NAME,U.CREATED_DT,U.CREATED_BY,U.UPDATED_DT,U.UPDATED_BY ,U.STATUS from USER_MSTR U,USER_MAPPING UM where UM.LOB_ID=? AND U.KM_ACTOR_ID=? AND U.USER_LOGIN_ID=UM.USER_LOGIN_ID with ur";
	protected static final String SQL_SELECT_USERDOWNLOADREPORT_NAME="SELECT U.USER_LOGIN_ID,UM.CIRCLE_ID,U.USER_FNAME,U.USER_MNAME,U.USER_LNAME,U.ROLE,U.USER_EMAILID,U.USER_MOBILE_NUMBER,U.PARTNER_NAME,U.CREATED_DT,U.CREATED_BY,U.UPDATED_DT,U.UPDATED_BY ,U.STATUS  from USER_MSTR U,USER_MAPPING UM where UM.CIRCLE_ID=?   AND  UM.LOB_ID=? AND U.KM_ACTOR_ID=? AND U.USER_LOGIN_ID=UM.USER_LOGIN_ID with ur";
	//Added by Sudhanshu>
	
	/* Added by parnika */
	protected static final String SQL_GET_DETAILS_FROM_LEAD = "SELECT LD.LEAD_ID, PM.PRODUCT_LOB_ID , LPD.CIRCLE_ID FROM LEAD_DATA LD, LEAD_PROSPECT_DETAIL LPD , PRODUCT_MSTR PM WHERE LD.LEAD_PROSPECT_ID = LPD.LEAD_PROSPECT_ID AND PM.PRODUCT_ID = LD.PRODUCT_ID AND LD.LEAD_ID = ? WITH UR";
	
	protected static final String SQL_SELECT_RSU_IN_CIRCLE = "SELECT RSU_CODE FROM RSU_MSTR RM, CITY_ZONE_MSTR CZM, CITY_MSTR CIM, ZONE_MSTR ZM, CIRCLE_MSTR CM WHERE RM.CITY_ZONE_CODE = CZM.CITY_ZONE_CODE AND CZM.CITY_CODE = CIM.CITY_CODE AND CIM.ZONE_CODE = ZM.ZONE_CODE AND ZM.CIRCLE_MSTR_ID = CM.CIRCLE_MSTR_ID AND CM.CIRCLE_ID = ? AND CM.LOB_ID = ? AND RM.RSU_CODE = ? AND RM.STATUS = 'A' WITH UR";
	
	protected static final String SQL_SELECT_LEAD_STATUS_MTD ="SELECT LEAD_STATUS_ID, LEAD_STATUS, LEAD_STATUS_NAME FROM LEAD_STATUS WHERE LEAD_STATUS_ID IN (" +Constants.LEAD_STATUS_OPEN +","+Constants.LEAD_STATUS_VERIFICATION +","+Constants.LEAD_STATUS_QUALIFIED +","+Constants.LEAD_STATUS_ASSIGNED +","+Constants.LEAD_STATUS_RE_ASSIGNED +","+Constants.LEAD_STATUS_WON +","+Constants.LEAD_SUB_STATUS_LOST +","+Constants.LEAD_STATUS_FEASIBILITY +","+Constants.LEAD_STATUS_WIRED +","+Constants.LEAD_STATUS_UNWIRED +","+Constants.LEAD_STATUS_INFO_INADEQUATE +","+Constants.LEAD_STATUS_AUTO_CLOSE +" )WITH UR";
	
	protected static final String SQL_SELECT_REPORT_TYPE_ADMIN = "SELECT REPORT_ID, REPORT_NAME FROM REPORT_MSTR WHERE REPORT_STATUS = 'C' WITH UR";
	
	/* End of changes by Parnika */
	
	// Added by Bhaskar
	//added by Nancy
	 protected static final String SQL_SELECT_LEAD_SUB_STATUS ="select LS.LEAD_STATUS,LSS.UNIQUE_ID,LSS.SUB_STATUS_ID,LSS.SUB_STATUS,LSS.LEAD_STATUS_ID,LSS.LEAD_SUB_STATUS_DISPLAY,LSS.PRODUCT_LOB_ID,PB.PRODUCT_LOB from LEAD_STATUS LS,LEAD_SUB_STATUS LSS,PRODUCT_LOB PB WHERE LS.LEAD_STATUS_ID=LSS.LEAD_STATUS_ID AND PB.PRODUCT_LOB_ID=LSS.PRODUCT_LOB_ID AND LS.LEAD_STATUS_ID=? and LSS.PRODUCT_LOB_ID=? WITH UR";
	 
	 protected static final String SQL_SELECT_LEAD_SUB_STATUS1 ="select LS.LEAD_STATUS,LSS.UNIQUE_ID,LSS.SUB_STATUS_ID,LSS.SUB_STATUS,LSS.LEAD_STATUS_ID,LSS.LEAD_SUB_STATUS_DISPLAY,LSS.PRODUCT_LOB_ID,PB.PRODUCT_LOB from LEAD_STATUS LS,LEAD_SUB_STATUS LSS,PRODUCT_LOB PB WHERE LS.LEAD_STATUS_ID=LSS.LEAD_STATUS_ID AND PB.PRODUCT_LOB_ID=LSS.PRODUCT_LOB_ID AND LS.LEAD_STATUS_ID=? and LSS.PRODUCT_LOB_ID=?  AND LSS.SUB_STATUS_ID=? WITH UR";
	...
	protected static final String SQL_SELECT_LEAD_SUB_SUB_STATUS1="SELECT LSSS.SUB_SUB_STATUS_ID,LSSS.SUB_SUB_STATUS,LSSS.LEAD_SUB_SUB_STATUS_DISPLAY,LS.LEAD_STATUS,LSS.UNIQUE_ID,LSS.SUB_STATUS_ID,LSS.SUB_STATUS,LSS.LEAD_STATUS_ID,LSS.LEAD_SUB_STATUS_DISPLAY,LSS.PRODUCT_LOB_ID,PB.PRODUCT_LOB FROM LEAD_SUB_SUB_STATUS LSSS,LEAD_SUB_STATUS LSS,LEAD_STATUS LS,PRODUCT_LOB PB "+
	 ...
	 "AND LSS.SUB_STATUS_ID=LSSS.LEAD_SUB_STATUS_ID AND LSSS.SUBSTATUS_CODE=LSS.UNIQUE_ID AND LSSS.LEAD_SUB_STATUS_ID=? and LSSS.SUB_SUB_STATUS_ID=? WITH UR";
	...
	protected static final String SQL_VALIDATE_RSU_REVERSE="select CL.CIRCLE_ID, PM.PRODUCT_ID from (select CIRCLE_ID,LOB_ID from CIRCLE_MSTR where CIRCLE_MSTR_ID= (select CIRCLE_MSTR_ID from ZONE_MSTR where zone_code= (" +
			...
			" CL.LOB_ID=PM.PRODUCT_LOB_ID  and PM.PRODUCT_ID=? with ur";
	protected static final String SQL_SELECT_LEAD_SUB_STATUS_LIST ="SELECT LS.SUB_SUB_STATUS,LS.SUB_SUB_STATUS_ID from LEAD_SUB_SUB_STATUS LS,LEAD_SUB_STATUS L , LEAD_STATUS LT WHERE LS.LEAD_SUB_STATUS_ID=L.SUB_STATUS_ID  and l.LEAD_STATUS_ID = lt.LEAD_STATUS_ID and L.SUB_STATUS_ID=? WITH UR";
	// ADDED BY NANCY
	...
	protected static final String SQL_SELECT_REQUEST_CATEGORY_MSTR="SELECT REQUEST_CATEGORY_ID,REQUEST_CATEGORY FROM REQUEST_CATEGORY_MSTR WHERE PRODUCT_ID=? AND  STATUS='A' WITH UR";
	//Added by Nehil
	...
	private static final String SQL_VALIDATE_PRODUCT_LOB_ID_RSU="SELECT PRODUCT_LOB_ID  FROM PRODUCT_MSTR WHERE PRODUCT_ID=? AND STATUS='A' WITH UR";
	...
	private static final String SQL_SELECT_REQUEST_CATEGORY_MSTR_LOB="SELECT REQUEST_CATEGORY_ID,REQUEST_CATEGORY FROM REQUEST_CATEGORY_MSTR WHERE STATUS='A' AND PRODUCT_ID = ? and REFUND_CATEGORY = 'N' with ur ";
	private static final String SQL_VALIDATE_CITY_ZONE_RSU_REVERSE ="SELECT RS.RSU_CODE FROM RSU_MSTR RS, CITY_MSTR CM, ZONE_MSTR ZM,CIRCLE_MSTR CIM,CITY_ZONE_MSTR CZM  WHERE RS.RSU_CODE=? AND  RS.STATUS='A' AND ZM.CIRCLE_MSTR_ID = CIM.CIRCLE_MSTR_ID AND  CM.ZONE_CODE = ZM.ZONE_CODE AND CM.CITY_CODE=? AND CZM.CITY_ZONE_CODE=? AND CM.STATUS='A' AND CIM.CIRCLE_ID =? AND CIM.LOB_ID =(SELECT PRODUCT_LOB_ID FROM PRODUCT_MSTR WHERE STATUS='A' AND  PRODUCT_ID=>?) WITH UR";
	//private static final String SQL_VALIDATE_CITY_RSU_REVERSE="SELECT RS.RSU_CODE FROM RSU_MSTR RS, CITY_MSTR CM, ZONE_MSTR ZM,CIRCLE_MSTR CIM,CITY_ZONE_MSTR CZM  WHERE RS.RSU_CODE=? AND  RS.STATUS='A' AND ZM.CIRCLE_MSTR_ID = CIM.CIRCLE_MSTR_ID AND  CM.ZONE_CODE = ZM.ZONE_CODE AND CM.CITY_CODE=? AND CZM.CITY_ZONE_CODE=RS.CITY_ZONE_CODE AND CM.STATUS='A' AND CIM.CIRCLE_ID = ? AND CIM.LOB_ID =(SELECT PRODUCT_LOB_ID FROM PRODUCT_MSTR WHERE STATUS='A' AND  PRODUCT_ID=?) WITH UR";
	//private static final String SQL_VALIDATE_CITY_ZONENEW_RSU_REVERSE="SELECT RS.RSU_CODE FROM RSU_MSTR RS, CITY_MSTR CM, ZONE_MSTR ZM,CIRCLE_MSTR CIM,CITY_ZONE_MSTR CZM  WHERE RS.RSU_CODE=? AND  RS.STATUS='A' AND ZM.CIRCLE_MSTR_ID = CIM.CIRCLE_MSTR_ID AND  CM.ZONE_CODE = ZM.ZONE_CODE AND CZM.CITY_ZONE_CODE=? AND CZM.CITY_CODE=CM.CITY_CODE AND CM.STATUS='A' AND CIM.CIRCLE_ID = ? AND CIM.LOB_ID =(SELECT PRODUCT_LOB_ID FROM PRODUCT_MSTR WHERE STATUS='A' AND  PRODUCT_ID=?) WITH UR";
	private static final String SQL_SELECT_RSU_FOR_CIRCLE="SELECT RSU_ID,RSU_CODE FROM RSU_MSTR WHERE STATUS='A' AND  CITY_ZONE_CODE IN (SELECT CITY_ZONE_CODE FROM CITY_ZONE_MSTR WHERE STATUS='A' AND CITY_CODE IN (SELECT CITY_CODE FROM CITY_MSTR WHERE STATUS='A' AND  ZONE_CODE IN (SELECT ZONE_CODE FROM ZONE_MSTR WHERE STATUS='A' AND CIRCLE_MSTR_ID=?))) ORDER BY RSU_CODE WITH UR";
	private static final String SQL_SELECT_RSUCITY_FOR_CIRCLE="SELECT RS.RSU_CODE FROM RSU_MSTR RS,CITY_ZONE_MSTR CZM,CITY_MSTR CMS,ZONE_MSTR Z,CIRCLE_MSTR CM WHERE CMS.CITY_CODE=? AND CM.CIRCLE_MSTR_ID=? AND CMS.ZONE_CODE=Z.ZONE_CODE AND CMS.CITY_CODE=CZM.CITY_CODE AND CZM.CITY_ZONE_CODE=RS.CITY_ZONE_CODE WITH UR";
	private static final String SQL_SELECT_RSUCITY_ZONE_CODE_FOR_CIRCLE="SELECT RS.RSU_CODE FROM RSU_MSTR RS,CITY_ZONE_MSTR CZM,CITY_MSTR CMS,ZONE_MSTR Z,CIRCLE_MSTR CM WHERE CMS.CITY_CODE=? AND CM.CIRCLE_MSTR_ID=? AND CZM.CITY_ZONE_CODE=? AND CMS.ZONE_CODE=Z.ZONE_CODE AND CMS.CITY_CODE=CZM.CITY_CODE AND CZM.CITY_ZONE_CODE=RS.CITY_ZONE_CODE ORDER BY RSU_CODE WITH UR";
	private static final String SQL_GET_REPORTID_FROM_REPORTNAME = "SELECT REPORT_ID FROM REPORT_MSTR WHERE REPORT_NAME=? WITH UR";
	//added by Nancy agrawal
	private static final String SQL_SELECT_CIRCLE_NAME="SELECT CIRCLE_NAME FROM CIRCLE_MSTR WHERE CIRCLE_MSTR_ID=? WITH UR";
private static final String SQL_SELECT_REPORT_CONFIGURATION = "SELECT FREQUENCY, TIMINGS, TO_RECIPIENTS, CC_RECIPIENTS, SUBJECT FROM RPT_CONFIGURATION WHERE REPORT_CONFIGURATION_ID=? WITH UR";
	...
	private static final String SQL_SELECT_DYNAMIC_REPORTS = "SELECT REPORT_ID, REPORT_NAME FROM DYNAMIC_REPORT_MSTR WHERE REPORT_STATUS='A' WITH UR";
	private static final String SQL_SELECT_ACTORS = "SELECT KM_ACTOR_ID, KM_ACTOR_NAME FROM KM_ACTORS WITH UR";
	private static final String SQL_SELECT_ALERT_MSG="select MSG_TEMPLATE from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_MSG1="select MSG_TEMPLATE from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_SMS_MSG="select SMS_TEMPLATE from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_SMS_MSG1="select SMS_TEMPLATE from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_DEFAULT="select DEFAULT_MESSAGE,DEFAULT_SMS from ALERT_EMAIL_MASTER where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_STATUS="select STATUS from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_STATUS1="select STATUS from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_ALERT_SUBJECT="select SUBJECT_TEMPLATE from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_SUBJECT1="select SUBJECT_TEMPLATE from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_ALERT_SMS1="select MOBILE_NUMBERS from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_ALERT_SMS="select MOBILE_NUMBERS from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_EMAIL1="select EMAIL_IDS from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_ALERT_EMAIL="select EMAIL_IDS from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_COUNT1="select THRESHOLD_COUNT from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_ALERT_COUNT="select THRESHOLD_COUNT from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_PERIOD1="select THRESHOLD_PERIOD from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_ALERT_PERIOD="select THRESHOLD_PERIOD from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_TYPE="select ALERT_TYPE from ALERT_EMAIL_CONFIG where alert_id=? WITH UR";
	private static final String SQL_SELECT_ALERT_TYPE1="select ALERT_TYPE from ALERT_EMAIL_CONFIG where alert_id=? and SOURCE_TYPE=? WITH UR";
	private static final String SQL_SELECT_ALERT_SOURCE="select SOURCE_TYPE from ALERT_EMAIL_CONFIG WHERE alert_id=? WITH UR";
	//private static final String SQL_SELECT_LEAD_SUB_SUB_STATUS="SELECT * FROM LEAD_SUB_SUB_STATUS LSSS,LEAD_SUB_STATUS LSS,LEAD_STATUS LS,PRODUCT_LOB PL WHERE LSS.PRODUCT_LOB_ID=PL.PRODUCT_LOB_ID AND LSSS.LEAD_SUB_STATUS_ID=LSS.SUB_STATUS_ID AND LSS.UNIQUE_ID=LSSS.SUBSTATUS_CODE AND LSS.SUB_STATUS_ID=? AND LSS.LEAD_STATUS_ID=? AND LSS.PRODUCT_LOB_ID=? WITH UR";
    
	 protected static final String SQL_SELECT_LEAD_SUB_SUB_STATUS="SELECT LSSS.SUB_SUB_STATUS_ID,LSSS.SUB_SUB_STATUS,LSSS.LEAD_SUB_SUB_STATUS_DISPLAY,LS.LEAD_STATUS,LSS.UNIQUE_ID,LSS.SUB_STATUS_ID,LSS.SUB_STATUS,LSS.LEAD_STATUS_ID,LSS.LEAD_SUB_STATUS_DISPLAY,LSS.PRODUCT_LOB_ID,PB.PRODUCT_LOB FROM LEAD_SUB_SUB_STATUS LSSS,LEAD_SUB_STATUS LSS,LEAD_STATUS LS,PRODUCT_LOB PB "+
	 "WHERE LS.LEAD_STATUS_ID=LSS.LEAD_STATUS_ID AND LSS.PRODUCT_LOB_ID=? AND LSS.LEAD_STATUS_ID=? AND PB.PRODUCT_LOB_ID=LSS.PRODUCT_LOB_ID "+
	 "AND LSS.SUB_STATUS_ID=LSSS.LEAD_SUB_STATUS_ID AND LSSS.SUBSTATUS_CODE=LSS.UNIQUE_ID AND LSSS.LEAD_SUB_STATUS_ID=? with ur";
...
private static final String SQL_SELECT_FOURG_PRODUCTS="SELECT PRODUCT_ID,PRODUCT_NAME,PRODUCT_LOB_ID FROM PRODUCT_MSTR WHERE PRODUCT_LOB_ID=24 AND STATUS='A' WITH UR";

private static final String SQL_SELECT_PRODUCT_LOB="SELECT PRODUCT_ID,PRODUCT_NAME FROM PRODUCT_MSTR WHERE PRODUCT_LOB_ID=? AND STATUS='A' WITH UR";

private static final String GET_APPROVERS_AND_DR_LIST = "SELECT APPROVER_L1,APPROVER_L2,DRLIST FROM OLM_APPROVER WHERE OLM_ID=?";Logger logger = Logger.getLogger(MasterDaoImpl.class);
...
public static MasterDaoImpl masterDaoInstance()
{
	...
	public String getMasterData(String masterTable, int lobId,int mstr) throws DAOException
	{
		...
		if(prodLobId==-2 || (masterTable=="LEAD_STATUS" || masterTable=="STATE_MSTR" || masterTable=="PRODUCT_LOB" || masterTable=="PRODUCT_MSTR" ||
				masterTable=="REQUEST_TYPE_MSTR" || masterTable=="SOURCE_MSTR" || masterTable=="SUB_SOURCE_MSTR" || masterTable=="USER_MSTR_ADDITIONAL"  ||masterTable=="ESCALATION_MSTR"))
		{	
			if("USER_MSTR_ADDITIONAL".equalsIgnoreCase(masterTable)){
			 ...
			 sql2 = "select * from " + masterTable +" WITH UR";
			}
		}
		
		else if((masterTable=="CIRCLE_MSTR" || masterTable=="LEAD_SUB_SUB_STATUS" || masterTable=="LEAD_SUB_STATUS" || masterTable=="AGENCY_ASSIGNMENT" || masterTable=="ZONE_MSTR"||
				masterTable=="CITY_MSTR"  || masterTable=="CITY_ZONE_MSTR" || masterTable=="PINCODE_MSTR" || masterTable=="RSU_MSTR" ||masterTable=="AUTO_ASSIGNMENT_MATRIX") &&   prodLobId != -2)
		{
			if(masterTable=="CIRCLE_MSTR") 	{
				
				sql2 = "SELECT * FROM CIRCLE_MSTR WHERE LOB_ID=?  WITH UR";
			} 
			else if(masterTable=="LEAD_SUB_SUB_STATUS"){
				
				sql2 = "SELECT * FROM LEAD_SUB_SUB_STATUS WHERE SUBSTATUS_CODE IN(SELECT UNIQUE_ID FROM LEAD_SUB_STATUS WHERE  PRODUCT_LOB_ID = ?)";
			}
			else if(masterTable=="LEAD_SUB_STATUS" || masterTable=="AGENCY_ASSIGNMENT") {
				
				sql2 = "SELECT * FROM "+masterTable+" WHERE  PRODUCT_LOB_ID = ? WITH UR";
			}
			else if(masterTable=="ZONE_MSTR") {
				
				sql2=	"SELECT * FROM ZONE_MSTR WHERE CIRCLE_MSTR_ID in(SELECT CIRCLE_MSTR_ID FROM CIRCLE_MSTR WHERE LOB_ID=?)  WITH UR";
			}
			else if(masterTable=="CITY_MSTR") {
				
				sql2=	"SELECT * FROM CITY_MSTR WHERE ZONE_CODE in(SELECT ZONE_CODE FROM ZONE_MSTR WHERE CIRCLE_MSTR_ID in(SELECT CIRCLE_MSTR_ID FROM CIRCLE_MSTR WHERE LOB_ID=?)) WITH UR";
			}
			else if(masterTable=="CITY_ZONE_MSTR"){
				
				sql2=	"SELECT * FROM CITY_ZONE_MSTR WHERE CITY_CODE in (SELECT CITY_CODE FROM CITY_MSTR WHERE ZONE_CODE in (SELECT ZONE_CODE FROM ZONE_MSTR WHERE CIRCLE_MSTR_ID in(SELECT CIRCLE_MSTR_ID FROM CIRCLE_MSTR WHERE LOB_ID=?))) WITH UR";
			}
			else if(masterTable=="PINCODE_MSTR") {
				
				sql2=	"SELECT * FROM PINCODE_MSTR WHERE CITY_ZONE_CODE in(SELECT CITY_ZONE_CODE FROM CITY_ZONE_MSTR WHERE CITY_CODE in (SELECT CITY_CODE FROM CITY_MSTR WHERE ZONE_CODE in (SELECT ZONE_CODE FROM ZONE_MSTR WHERE CIRCLE_MSTR_ID in(SELECT CIRCLE_MSTR_ID FROM CIRCLE_MSTR WHERE LOB_ID=?)))) WITH UR";
			}
			else if(masterTable=="RSU_MSTR") {
				
				sql2=	"SELECT * FROM RSU_MSTR WHERE CITY_ZONE_CODE in(SELECT CITY_ZONE_CODE FROM CITY_ZONE_MSTR WHERE CITY_CODE in (SELECT CITY_CODE FROM CITY_MSTR WHERE ZONE_CODE in (SELECT ZONE_CODE FROM ZONE_MSTR WHERE CIRCLE_MSTR_ID in(SELECT CIRCLE_MSTR_ID FROM CIRCLE_MSTR WHERE LOB_ID=?)))) WITH UR";
			}
			else if(masterTable=="AUTO_ASSIGNMENT_MATRIX" && mstr==15) {
				
				sql2=	"SELECT * FROM AUTO_ASSIGNMENT_MATRIX WHERE LOB_ID=? AND AUTO_ASSIGNMENT_TYPE='2' WITH UR";
			}
			else if(masterTable=="AUTO_ASSIGNMENT_MATRIX" && mstr==19) {
				
				sql2=	"SELECT * FROM AUTO_ASSIGNMENT_MATRIX WHERE LOB_ID=? AND AUTO_ASSIGNMENT_TYPE='1' WITH UR";
			}
		...
		try {
			...
			if((masterTable=="LEAD_SUB_SUB_STATUS" || masterTable=="LEAD_SUB_STATUS" || masterTable=="CIRCLE_MSTR" || masterTable=="AGENCY_ASSIGNMENT" || masterTable=="CITY_MSTR" ||masterTable=="ZONE_MSTR"||
					masterTable=="RSU_MSTR"|| masterTable=="PINCODE_MSTR" ||masterTable=="CITY_ZONE_MSTR" || (masterTable=="AUTO_ASSIGNMENT_MATRIX" && (mstr==15 || mstr==19))) &&   prodLobId != -2)
			{
	...
	public int getProductLobId(int productId) throws DAOException {
		...
		PreparedStatement ps = null;
		ResultSet rs = null;
		String sql = "SELECT PRODUCT_LOB_ID  FROM PRODUCT_MSTR WHERE PRODUCT_ID = ? AND STATUS ='A' WITH UR";
		int productLobId=0;
	...
	try {
		...
		logger.info("circle type all"+circleTableId);
		con = DBConnection.getDBConnection();
		...
		if(circleTableId == Constants.CIRCLE_TABLE_ID &&  usertype.equalsIgnoreCase("both"))
		{
			...
			"(SELECT u.PARTNER_NAME FROM USER_MSTR U WHERE  a.OLM_ID=u.USER_LOGIN_ID)AS PARTNER_NAME FROM ASSIGNMENT_MATRIX a   WHERE  a.PRODUCT_LOB_ID="+lobTableId+" AND  a.STATUS='A'  WITH UR";
		...
		else if(usertype.equalsIgnoreCase("both"))
		{
			...
			"(select c.CIRCLE_NAME from CIRCLE_MSTR c where a.CIRCLE_ID=c.CIRCLE_ID and c.LOB_ID="+lobTableId+") as CIRCLE_NAME,"+
			"(SELECT p.PRODUCT_LOB FROM PRODUCT_LOB p WHERE a.PRODUCT_LOB_ID=p.PRODUCT_LOB_ID ) AS PRODUCT_LOB,"+
			"(SELECT u.PARTNER_NAME FROM USER_MSTR U WHERE  a.OLM_ID=u.USER_LOGIN_ID)AS PARTNER_NAME FROM ASSIGNMENT_MATRIX a   WHERE a.CIRCLE_ID="+circleTableId+" AND a.PRODUCT_LOB_ID="+lobTableId+" AND  a.STATUS='A'  WITH UR";
		...
		else if (circleTableId == Constants.CIRCLE_TABLE_ID)
		{
			...
			"(select c.CIRCLE_NAME from CIRCLE_MSTR c where a.CIRCLE_ID=c.CIRCLE_ID and c.LOB_ID="+lobTableId+") as CIRCLE_NAME,"+
			"(SELECT p.PRODUCT_LOB FROM PRODUCT_LOB p WHERE a.PRODUCT_LOB_ID=p.PRODUCT_LOB_ID ) AS PRODUCT_LOB,"+
			"(SELECT u.PARTNER_NAME FROM USER_MSTR U WHERE  a.OLM_ID=u.USER_LOGIN_ID)AS PARTNER_NAME FROM ASSIGNMENT_MATRIX a   WHERE   a.PRODUCT_LOB_ID="+lobTableId+" AND a.USER_TYPE= '"+usertype+"' AND  a.STATUS='A'  WITH UR";
		...
		else
		{
			...
			"(select c.CIRCLE_NAME from CIRCLE_MSTR c where a.CIRCLE_ID=c.CIRCLE_ID and c.LOB_ID="+lobTableId+") as CIRCLE_NAME,"+
			"(SELECT p.PRODUCT_LOB FROM PRODUCT_LOB p WHERE a.PRODUCT_LOB_ID=p.PRODUCT_LOB_ID ) AS PRODUCT_LOB,"+
			"(SELECT u.PARTNER_NAME FROM USER_MSTR U WHERE  a.OLM_ID=u.USER_LOGIN_ID)AS PARTNER_NAME FROM ASSIGNMENT_MATRIX a   WHERE a.CIRCLE_ID="+circleTableId+" AND a.PRODUCT_LOB_ID="+lobTableId+" AND a.USER_TYPE= '"+usertype+"' AND  a.STATUS='A'  WITH UR";
		...
		while(rs.next()) {
			...
			//if(AssignmentValue.equals("A")) 
				...
				if(matrixList!=null && !matrixList.isEmpty()){
					...
					while(iterator.hasNext()){
						BulkMatrixDownloadDTO bDTO=iterator.next();
						//logger.info("Parnika ::::::::"+ bDTO.getProductId() + "Lead Product Id "+leadProductId );
				...
				if( level.equalsIgnoreCase("1") && (bDTO.getCityId().equals(city)) && (bDTO.getCircleId().equals(circle)) && (bDTO.getProductLobId().equals(product)) && (bDTO.getPincode().equals(pincode)) && (bDTO.getRsuId().equals(rsu)) && (bDTO.getZoneId().equals(zone) && (bDTO.getCityZoneCode().equals(cityZone)) && AssignmentValue.equalsIgnoreCase("E")))
				{
					...
					logger.info("level1cc"+bDTO.getLevel1CC());
...
public ArrayList<BulkMatrixDownloadDTO> getAssignmentDownloadData(int circleTableId, int lobTableId,String usertype) throws DAOException {Connection con = null;
	...
	try {
		...
		if(circleTableId == Constants.CIRCLE_TABLE_ID &&  usertype.equalsIgnoreCase("both"))
		{
			...
			"(select c.CIRCLE_NAME from CIRCLE_MSTR c where a.CIRCLE_ID=c.CIRCLE_ID and c.LOB_ID="+lobTableId+") as CIRCLE_NAME,"+
			"(SELECT p.PRODUCT_LOB FROM PRODUCT_LOB p WHERE a.PRODUCT_LOB_ID=p.PRODUCT_LOB_ID ) AS PRODUCT_LOB,"+
			"(SELECT u.PARTNER_NAME FROM USER_MSTR U WHERE  a.OLM_ID=u.USER_LOGIN_ID)AS PARTNER_NAME FROM ASSIGNMENT_MATRIX a   WHERE  a.PRODUCT_LOB_ID="+lobTableId+" AND  a.STATUS='A' ORDER BY a.PRIMARY_AUTH desc  WITH UR";
		...
		else if(usertype.equalsIgnoreCase("both"))
		{
			...
			"(select c.CIRCLE_NAME from CIRCLE_MSTR c where a.CIRCLE_ID=c.CIRCLE_ID and c.LOB_ID="+lobTableId+") as CIRCLE_NAME,"+
			"(SELECT p.PRODUCT_LOB FROM PRODUCT_LOB p WHERE a.PRODUCT_LOB_ID=p.PRODUCT_LOB_ID ) AS PRODUCT_LOB,"+
			"(SELECT u.PARTNER_NAME FROM USER_MSTR U WHERE  a.OLM_ID=u.USER_LOGIN_ID)AS PARTNER_NAME FROM ASSIGNMENT_MATRIX a   WHERE a.CIRCLE_ID="+circleTableId+" AND a.PRODUCT_LOB_ID="+lobTableId+" AND  a.STATUS='A' ORDER BY a.PRIMARY_AUTH desc WITH UR";
		...
		else if (circleTableId == Constants.CIRCLE_TABLE_ID)
		{
			...
			"(select c.CIRCLE_NAME from CIRCLE_MSTR c where a.CIRCLE_ID=c.CIRCLE_ID and c.LOB_ID="+lobTableId+") as CIRCLE_NAME,"+
			"(SELECT p.PRODUCT_LOB FROM PRODUCT_LOB p WHERE a.PRODUCT_LOB_ID=p.PRODUCT_LOB_ID ) AS PRODUCT_LOB,"+
			"(SELECT u.PARTNER_NAME FROM USER_MSTR U WHERE  a.OLM_ID=u.USER_LOGIN_ID)AS PARTNER_NAME FROM ASSIGNMENT_MATRIX a   WHERE   a.PRODUCT_LOB_ID="+lobTableId+" AND a.USER_TYPE= '"+usertype+"' AND  a.STATUS='A' ORDER BY a.PRIMARY_AUTH desc WITH UR";
		...
		else
		{
			...
			"(select c.CIRCLE_NAME from CIRCLE_MSTR c where a.CIRCLE_ID=c.CIRCLE_ID and c.LOB_ID="+lobTableId+") as CIRCLE_NAME,"+
			"(SELECT p.PRODUCT_LOB FROM PRODUCT_LOB p WHERE a.PRODUCT_LOB_ID=p.PRODUCT_LOB_ID ) AS PRODUCT_LOB,"+
			"(SELECT u.PARTNER_NAME FROM USER_MSTR U WHERE  a.OLM_ID=u.USER_LOGIN_ID)AS PARTNER_NAME FROM ASSIGNMENT_MATRIX a   WHERE a.CIRCLE_ID="+circleTableId+" AND a.PRODUCT_LOB_ID="+lobTableId+" AND a.USER_TYPE= '"+usertype+"' AND  a.STATUS='A' ORDER BY a.PRIMARY_AUTH desc  WITH UR";
		...
		AssignmentValue=Assignment.split("~")[9];
			...
			if (primary == 1) {
				...
				if(temp.size()>0)
					...
					while(iterator.hasNext()){
						 bDTO=iterator.next();
				//	logger.info("bDTO.getProductId(). PRIMARY LOOP..................."+bDTO.getProductId());
			...
			//if(AssignmentValue.equals("A")) 
				...
				if(matrixList!=null && !matrixList.isEmpty()){
					...
					while(iterator.hasNext()){
						BulkMatrixDownloadDTO bDTO=iterator.next();
						//logger.info("Parnika ::::::::"+ bDTO.getProductId() );
						if(!bDTO.getProductId().equalsIgnoreCase("-1") && bDTO.getProductId() !=null && !bDTO.getProductId().equalsIgnoreCase("")){
	...
	/*public String getDataForPinCode(String pinCode,int circleMstrId) throws DAOException {
		logger.info("111111 came in daoimple getDataForPinCode  ***********:"+pinCode);
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		String cityCode="";
		String cityName="";
		String GET_CITY_CODE=" SELECT ZONE_CODE,CITY_CODE,CITY_NAME FROM CITY_MSTR WHERE CITY_CODE=? AND STATUS='A' WITH UR";
		String GET_ZONE_CODE=" SELECT ZONE_CODE,ZONE_NAME,CIRCLE_MSTR_ID FROM ZONE_MSTR WHERE ZONE_CODE=? AND STATUS='A' WITH UR ";
		String GET_ZONE_CODE_FROM_CITY=" SELECT ZONE_CODE  from CITY_MSTR WHERE CITY_CODE= ? AND STATUS='A' WITH UR ";
		String GET_CITYZONE_FROM_PIN_CODE=" SELECT CITY_CODE,CITY_ZONE_CODE,CITY_ZONE_NAME FROM CITY_ZONE_MSTR WHERE CITY_ZONE_CODE = ( SELECT CITY_ZONE_CODE FROM PINCODE_MSTR WHERE PINCODE=?  AND STATUS='A' WITH UR ) AND STATUS='A' WITH UR";
		String zone_code="";
		String zone_name="";
	...
	public String getDataForPinCode(String pinCode,int circleMstrId) throws DAOException {
		logger.info(" in getDataForPinCode of masterdaoimpl :::::");
		Connection con = null;
...
"zm.CIRCLE_MSTR_ID= cm.CIRCLE_MSTR_ID and pm.PINCODE=? AND cm.CIRCLE_MSTR_ID=? AND pm.STATUS='A' with UR";
	...
	public boolean isValidBulkUserCircle_LOB(String circleListStr,
	    ...
	    try {
	    		...
	    		{
	    			ps = con.prepareStatement("SELECT  * FROM CIRCLE_MSTR WHERE LOB_ID=? and CIRCLE_ID = ? AND CIRCLE_ID >= 0 WITH UR");
	    			ps.setInt(1, productLobId);
	...
	public boolean isValidCityZoneCode(String cityzoneCode, int circleId,int productLobId) throws DAOException {Connection con = null;
			...
			try {
				// 
				con = DBConnection.getDBConnection();
				//select CL.CIRCLE_ID,LOB_ID from (select * from CIRCLE_MSTR whereCIRCLE_MSTR_ID= (select CIRCLE_MSTR_ID from ZONE_MSTR where zone_code= (select zone_code  from CITY_MSTR whereCITY_CODE= ( select CITY_CODE  from CITY_ZONE_MSTR where CITY_ZONE_CODE=?))) and circle_id=? ) as CL where lob_id=? with ur
				ps = con.prepareStatement("select CL.CIRCLE_ID,LOB_ID from (select * from CIRCLE_MSTR where CIRCLE_MSTR_ID= (select CIRCLE_MSTR_ID from ZONE_MSTR where zone_code= (select zone_code  from CITY_MSTR where CITY_CODE= ( select CITY_CODE  from CITY_ZONE_MSTR where CITY_ZONE_CODE=?))) and circle_id=? ) as CL where lob_id=? with ur");
				ps.setString(1,cityzoneCode);
				ps.setInt(2,circleId);
				ps.setInt(3,productLobId);
				rs = ps.executeQuery();
		...
		Connection con = null;
				...
				try{
						...
						if(circleTableId == -2 && productlobId != -2)
						{
							...
							query= "SELECT U.USER_LOGIN_ID,UM.CIRCLE_ID,U.USER_FNAME,U.USER_MNAME,U.USER_LNAME,U.ROLE,U.USER_EMAILID,U.USER_MOBILE_NUMBER,U.PARTNER_NAME,U.CREATED_DT,U.CREATED_BY,U.UPDATED_DT,U.UPDATED_BY ,U.STATUS  from USER_MSTR U,USER_MAPPING UM where  UM.LOB_ID="+productlobId+" AND U.KM_ACTOR_ID="+selectActorId+" AND U.USER_LOGIN_ID=UM.USER_LOGIN_ID with ur";
						}
						else if(productlobId == -2 && circleTableId == -2){
							query= "SELECT U.USER_LOGIN_ID,UM.CIRCLE_ID,U.USER_FNAME,U.USER_MNAME,U.USER_LNAME,U.ROLE,U.USER_EMAILID,U.USER_MOBILE_NUMBER,U.PARTNER_NAME,U.CREATED_DT,U.CREATED_BY,U.UPDATED_DT,U.UPDATED_BY ,U.STATUS  from USER_MSTR U,USER_MAPPING UM where U.KM_ACTOR_ID="+selectActorId+" AND U.USER_LOGIN_ID=UM.USER_LOGIN_ID with ur";
							
						}
						else if(productlobId == -2 && circleTableId!= -2){
							query= "SELECT U.USER_LOGIN_ID,UM.CIRCLE_ID,U.USER_FNAME,U.USER_MNAME,U.USER_LNAME,U.ROLE,U.USER_EMAILID,U.USER_MOBILE_NUMBER,U.PARTNER_NAME,U.CREATED_DT,U.CREATED_BY,U.UPDATED_DT,U.UPDATED_BY ,U.STATUS  from USER_MSTR U,USER_MAPPING UM where  UM.CIRCLE_ID="+circleTableId+"  AND U.KM_ACTOR_ID="+selectActorId+" AND U.USER_LOGIN_ID=UM.USER_LOGIN_ID with ur";
						...
						else
						{
							...
							query= "SELECT U.USER_LOGIN_ID,UM.CIRCLE_ID,U.USER_FNAME,U.USER_MNAME,U.USER_LNAME,U.ROLE,U.USER_EMAILID,U.USER_MOBILE_NUMBER,U.PARTNER_NAME,U.CREATED_DT,U.CREATED_BY,U.UPDATED_DT,U.UPDATED_BY ,U.STATUS  from USER_MSTR U,USER_MAPPING UM where UM.CIRCLE_ID="+circleTableId+"   AND  UM.LOB_ID="+productlobId+" AND U.KM_ACTOR_ID="+selectActorId+" AND U.USER_LOGIN_ID=UM.USER_LOGIN_ID with ur";
...
public ArrayList<BulkCityZoneCodeCTO> getAssignmentMatrixDataForCityZoneCode(String cityZoneCode, int circleId, int productLobId) throws DAOException {
	...
	String query="SELECT  CZM.CITY_CODE, CM.ZONE_CODE FROM CITY_ZONE_MSTR CZM, CITY_MSTR CM, ZONE_MSTR ZM , CIRCLE_MSTR CIM WHERE ucase(CZM.CITY_ZONE_CODE)=? AND CZM.CITY_CODE = CM.CITY_CODE AND CM.ZONE_CODE = ZM.ZONE_CODE AND ZM.CIRCLE_MSTR_ID = CIM.CIRCLE_MSTR_ID AND CIM.CIRCLE_ID =? AND CIM.LOB_ID =?  WITH UR ";
...
public ArrayList<BulkCityDTO> getAssignmentMatrixDataForCityCode(String city, int circleId, int productLobId) throws DAOException {
	...
	//String query="select ZONE_CODE from CITY_MSTR WHERE CITY_CODE = ? AND STATUS='A' WITH UR";
	
	String query="SELECT CM.ZONE_CODE FROM  CITY_MSTR CM, ZONE_MSTR ZM,CIRCLE_MSTR CIM  WHERE  CM.ZONE_CODE = ZM.ZONE_CODE AND CM.CITY_CODE=? AND CM.STATUS='A' AND   ZM.CIRCLE_MSTR_ID = CIM.CIRCLE_MSTR_ID AND  CIM.CIRCLE_ID = ? AND CIM.LOB_ID =? WITH UR ";
...
public  ArrayList<UserMstr> getLogedInUserDetails(String userLoginId , int lobId) throws DAOException
{
	...
	try {
		...
		if (lobId !=0 ) {
			...
			query.append("and UM.LOB_ID = ? with ur ");
...
/* End of changes By Parnika */
		...
		public ArrayList<RSUDTO> getRsuForCityChange(int circleMstriD,
			...
			ArrayList<RSUDTO> rsuList = new ArrayList<RSUDTO>();
			RSUDTO dto = null;
			//private static final String SQL_SELECT_RSUCITY_FOR_CIRCLE="SELECT RS.RSU_ID,RS.RSU_CODE FROM RSU_MSTR RS,CITY_ZONE_MSTR CZM,CITY_MSTR CMS,ZONE_MSTR Z,CIRCLE_MSTR CM WHERE CM.CITY_CODE=? AND CM.CIRCLE_MSTR_ID=? AND CMS.ZONE_CODE=Z.ZONE_CODE AND CMS.CITY_CODE=CZM.CITY_CODE AND CZM.CITY_ZONE_CODE=RS.CITY_ZONE_CODE WITH UR";
			try {
		...
		public String getSubject(String alert,String source) throws DAOException
		{
			...
			try {
				...
				while(rs.next()) 
				{
					...
					//logger.info("dao impl SUBJECT_TEMPLATE"+subject);
					return subject;
				}
			} catch (Exception e) {
				e.printStackTrace();
		...
		public String getCount(String alert,String source) throws DAOException{
			...
			try {
				...
				if(alert.equals("3"))
				{
					...
					ps.setString(2,source);
					//logger.info(source+"...alert THRESHOLD_COUNT:"+alert);
				}
				else
				{
				...
				while(rs.next()) {
					...
					//logger.info("dao impl THRESHOLD_COUNT"+count);
				return count;
				}
			} catch (Exception e) {
				throw new DAOException("Exception occured :  "+ e.getMessage(),e);
...
public int getReportId(String reportName) throws DAOException
		...
		{
			String FIND_IF_REPORT_ID_EXIST = "SELECT REPORT_CONFIGURATION_ID from RPT_CONFIGURATION Where REPORT_CONFIGURATION_ID=? WITH UR";
		...
		{
			final String GET_REPORT_CONFGIURATION_ID = "SELECT REPORT_CONFIGURATION_ID FROM REPORT_CONFIGURATION WHERE REPORT_ID=? and ACTOR_ID=? and LOB_ID=? WITH UR";
			Connection con = null;
			PreparedStatement ps = null;
			ResultSet rs = null;
		...
		public List<ColumnDto> getColumns(String reportConfigId, int actorId, int lobId) throws DAOException
		{
			...
			" (COL_ID not in ( SELECT Column_id from FE_Configuration WHERE REPORT_CONFIGURATION_ID=? WITH UR)) WITH UR";
			
			final String GET_SELECTED_COLUMNS = "SELECT COLUMN_ID, COL_NAME, FRONTEND_NAME FROM FE_CONFIGURATION fc, TABLE_CONFIGURATION tc WHERE fc.REPORT_CONFIGURATION_ID=? and fc.COLUMN_ID = tc.COL_ID WITH UR";
		...
		{
			String SQL_SELECT_PRODUCTS = "SELECT PRODUCT_ID, PRODUCT_NAME  FROM PRODUCT_MSTR WHERE STATUS='A' WITH UR";
			Connection con = null;
			PreparedStatement ps = null;
			ResultSet rs = null;
		...
		{
			String SQL_SELECT_FID_FOR_REPORT = "SELECT FORM_ID, PAGE_URL FROM FORM_DETAILS WHERE STATUS = 'A' and FORM_ID NOT IN (SELECT FID_PRODUCT FROM FID_PRODUCT_CONFIGURATION WHERE RPT_CONFIGURATION_ID=? WITH UR) WITH UR";
			Connection con = null;
			PreparedStatement ps = null;
			ResultSet rs = null;
		...
		{
			String SQL_SELECT_FID_FOR_REPORT = "SELECT FORM_ID, PAGE_URL FROM FORM_DETAILS WHERE STATUS = 'A' WITH UR";
			Connection con = null;
			PreparedStatement ps = null;
			ResultSet rs = null;
			List<FidDto> inVisibleFids = new ArrayList<FidDto>();
		...
		{
			String SQL_SELECT_FID_FOR_REPORT = "SELECT FID_PRODUCT FROM FID_PRODUCT_CONFIGURATION WHERE RPT_CONFIGURATION_ID = ? WITH UR";
			Connection con = null;
			PreparedStatement ps = null;
			ResultSet rs = null;
		...
		{
			String SQL_PRODUCTS_FOR_REPORT_ID = "Select FID_PRODUCT from FID_PRODUCT_CONFIGURATION WHERE RPT_CONFIGURATION_ID=?  WITH UR";
			Connection con = null;
			PreparedStatement ps = null;
			ResultSet rs = null;
		...
		{			
			...
			final String GET_ALL_COLUMNS = "SELECT COL_ID, COL_NAME FROM TABLE_CONFIGURATION WITH UR";
		...
		{			
			...
			final String GET_REPORT_ID = "Select MAX(REPORT_ID)+1 FROM DYNAMIC_REPORT_MSTR WITH UR";
		...
		{			
			...
			final String REPORT_EXIST = "SELECT * FROM RPT_CONFIGURATION WHERE REPORT_NAME = ? AND STATUS IN ('A','H') WITH UR";
		...
		{			
			...
			final String GET_DYNAMIC_REPORT_NAME = "SELECT REPORT_NAME FROM DYNAMIC_REPORT_MSTR WHERE REPORT_ID=? WITH UR";
		...
		public int getProductId(long leadId) throws DAOException {
			...
			PreparedStatement ps = null;
			ResultSet rs = null;
			String sql = "SELECT PRODUCT_LOB_ID FROM LEAD_PROSPECT_DETAIL WHERE LEAD_ID =? WITH UR";
			int productLobId=0;
		...
		public int getProduct(long leadId) throws DAOException {
			...
			PreparedStatement ps = null;
			ResultSet rs = null;
			String sql = "SELECT PRODUCT_ID FROM LEAD_DATA WHERE LEAD_ID =? WITH UR";
			int productLobId=0;
...
//added by Nancy
		...
		public LeadStatusDTO addSubStatus(int statusId,int lobId,String subStatusName) throws DAOException
		{
			...
			try {
				...
				con = DBConnection.getDBConnection();
				StringBuffer select_existing_subStatus_query = new StringBuffer("select * from LEAD_SUB_STATUS where LEAD_STATUS_ID = ? AND PRODUCT_LOB_ID=? AND SUB_STATUS=? WITH UR");
				StringBuffer select_existing_subStatusId_query = new StringBuffer("select * from LEAD_SUB_STATUS where LEAD_STATUS_ID = ? AND PRODUCT_LOB_ID=? AND SUB_STATUS_ID=? WITH UR");
		...
		public  int getSubStatusId(int statusId) throws DAOException
		{
			...
			try {
				...
				if(rs.next())
				{
					//logger.info(rs.getInt("SEQ_ID")+"-"+statusId+"-"+subStatusId);
	...
	// end of changes by Nancy	
		...
		public ArrayList<PINCodeDTO>getPinCodeListFor4G () throws DAOException
		{
			...
			PreparedStatement ps = null;
			ResultSet rs = null;
			String sql = "SELECT * FROM PINCODE_MSTR WHERE CITY_ZONE_CODE in(select CITY_ZONE_CODE from CITY_ZONE_MSTR where CITY_CODE in (select city_code from CITY_MSTR where ZONE_CODE in(select zone_code from ZONE_MSTR where CIRCLE_MSTR_ID in (select CIRCLE_MSTR_ID from CIRCLE_MSTR where LOB_ID=24)))) with ur";
...
//added by satish
		...
		public NoneditablefieldsDTO getNonEditableFiedls(String leadID)throws DAOException{
			...
			try{
				...
				while(rs.next()) {
					...
					logger.info(rs.getString("PREVIOUS_OPERATOR"));
					...
					logger.info(rs.getString("PREVIOUS_CIRCLE"));
					...
					logger.info(rs.getString("RELATION_NAME"));
					}
			}
			catch(Exception e){
				e.printStackTrace();
		...
		public ArrayList<LeadDetailsDTO> getPreviousoperatornameList()throws DAOException{
			...
			try{
				con = DBConnection.getDBConnection();
				ps = con.prepareStatement("select distinct PREVIOUS_OPERATOR from LEAD_UPDATE_DATA with UR");
				rs = ps.executeQuery();
				while(rs.next()){
...
public boolean isValidOlm(String olmId) throws DAOException {
	...
	try{
		con=DBConnection.getDBConnection();
		ps=con.prepareStatement("SELECT USER_LOGIN_ID FROM USER_MSTR WHERE USER_LOGIN_ID=? AND STATUS='A' with UR");
		ps.setString(1, olmId);
		rs=ps.executeQuery();
		if(rs.next()){
			return true;
...
public boolean isValidProuct(String product) throws DAOException {
	...
	try{
		con=DBConnection.getDBConnection();
		ps=con.prepareStatement("SELECT PM.PRODUCT_ID FROM PRODUCT_MSTR PM, PRODUCT_SYNONYM PS where PM.PRODUCT_ID=PS.PRODUCT_ID and ucase(PM.PRODUCT_NAME)=ucase(?) with UR");
		...
		if(rs.next()){
			...
			//logger.info(ServerPropertyReader.getString("FORWARD_ASSIGN_BULK_PRODUCT"));
			List<String> productsForFwd=Arrays.asList(masterSrvc.getParameterName("NEW_PRODUCT").trim().split(","));
			logger.info(productsForFwd.size());
